...
修复 AskUserQuestion 选项卡片显示在引出它的助手文本上方的问题。当一条消息的文本与其工具调用共享同一时间戳时，文本现在会正确显示在卡片上方，符合自然阅读顺序。

### 聊天排序
- 修复 AskUserQuestion 与权限选项卡片显示在助手消息文本上方的问题 —— 文本与它触发的卡片共享同一时间戳，排序的 tie-breaker 现在会在倒序聊天列表中让文本保持在上方
