...
export const ca: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    requestTimingDiagnostics: "Diagnòstic de temps de sol·licitud",
    requestTimingDiagnosticsEnabled:
      "Registra els temps de petició i torn per analitzar-los després",
    requestTimingDiagnosticsDisabled:
      "No registris dades addicionals de temps de petició",
  ...
  sessionInfo: {
    ...
    requestTimingTtft: "Temps fins al primer token",
