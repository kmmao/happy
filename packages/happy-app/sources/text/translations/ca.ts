...
export const ca: TranslationStructure = {
  ...
  projects: {
    ...
    knowledgeConfigModeAutoHint: "Decideix automàticament quant context injectar segons la rellevància",
    knowledgeConfigModeFullHint: "Sempre injecta tot el coneixement disponible al context de la sessió",
    knowledgeConfigModeMinimalHint: "Només injecta coneixement crític — convencions i advertiments",
    knowledgeConfigSensitivity: "Sensibilitat de recollida",
    knowledgeConfigSensitivityConservativeHint: "Només recull descobriments i decisions d'alta confiança",
    knowledgeConfigSensitivityBalancedHint: "Recull la majoria de troballes amb filtratge de confiança moderat",
    knowledgeConfigSensitivityAggressiveHint: "Recull tot — incloent observacions de baixa confiança",
    knowledgeConfigCollection: "Activadors de recollida",
    knowledgeConfigTrackFileEdits: "Rastrejar edicions de fitxers",
    knowledgeConfigTrackFileEditsHint: "Registra coneixement quan es creen o modifiquen fitxers",
    knowledgeConfigTrackToolCalls: "Rastrejar crides a eines",
    knowledgeConfigTrackToolCallsHint: "Registra coneixement de les invocacions d'eines i els seus resultats",
    knowledgeConfigTrackTokens: "Rastrejar sortida de tokens",
    knowledgeConfigTrackTokensHint: "Registra coneixement de les respostes de l'assistent d'IA",
    knowledgeConfigLifecycle: "Cicle de vida",
    knowledgeConfigRefine: "Refinament per IA",
    knowledgeConfigRefineHint: "Utilitza IA per millorar, deduplicar i enriquir noves entrades",
    knowledgeConfigDecay: "Arxiu automàtic",
    knowledgeConfigDecayHint: "Arxiva automàticament entrades no accedides en més de 30 dies",
    knowledgeConfigMerge: "Fusió intel·ligent",
    knowledgeConfigMergeHint: "Cerca i fusiona periòdicament entrades similars utilitzant IA",
