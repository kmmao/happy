...
export const ca: TranslationStructure = {
  ...
  supervisor: {
    ...
    autoLoopThresholdHint: ({ value }: { value: number }) => `L'auto-loop es dispara quan healthScore ≥ ${value}. Més alt = menys saludable. 24h de refredament entre auto-arrencades.`,
