...
export const ca: TranslationStructure = {
  ...
  analytics: {
    ...
    last7Days: "7 dies",
    last30Days: "30 dies",
    tokenTrend: "Tendència de tokens",
    costTrend: "Tendència de costos",
    costByModel: "Cost per model",
    tokensByModel: "Tokens per model",
    supervisorCost: "Cost del supervisor",
    totalRuns: "Execucions",
    agentEfficiency: "Eficiència de l'agent",
    completionRate: "Taxa de finalització",
    avgDuration: "Durada mitjana",
    avgCostPerRun: "Cost mitjà/execució",
    avgTokensPerRun: "Tokens mitjans/execució",
    completed: "Completat",
    failed: "Fallat",
    noData: "Sense dades analítiques",
    noDataSubtitle: "Les dades d'ús apareixeran aquí quan les sessions s'executin",
  },
