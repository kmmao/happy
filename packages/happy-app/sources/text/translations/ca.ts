...
export const ca: TranslationStructure = {
  ...
  settingsVoice: {
    ...
    voiceBackendTitle: "Backend de veu en temps real",
    voiceBackendDescription: "Tria el motor de veu en temps real utilitzat per a converses en directe.",
    livekitServerManagedNote: "Sense credencials configurades — s’utilitzen credencials LiveKit Cloud gestionades pel servidor. Afegeix les teves pròpies claus a continuació per a BYOK.",
    livekitConfig: "LiveKit Cloud",
    livekitConfigDescription: "Opcional: proporciona el teu propi LiveKit Cloud API Key, Secret i WSS URL. L’ús es facturarà al teu compte de LiveKit en lloc del del servidor.",
    livekitApiKeyPlaceholder: "API Key (p. ex. APIxxxxxxxx)",
    livekitApiSecretPlaceholder: "API Secret",
    livekitWssUrlPlaceholder: "WSS URL (p. ex. wss://xxx.livekit.cloud)",
    livekitSaveVerify: "Desa i verifica",
    livekitVerifying: "Verificant...",
    livekitVerified: "Verificat",
    livekitVerifySuccess: "Connectat — credencials de LiveKit vàlides",
    livekitProject: "Projecte",
    livekitActiveRooms: "Sales actives",
    livekitMode: "Modalitat",
    livekitParticipants: "participants connectats",
    livekitViewUsage: "Veure ús a LiveKit Cloud",
    livekitInvalidCredentials: "Credencials de LiveKit no vàlides",
