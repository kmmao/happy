...
export const ca: TranslationStructure = {
  ...
  workflows: {
    ...
    sectionModel: "Model",
    sectionEffort: "Esforç de raonament",
    effortDefault: "Predeterminat",
    modelFollowsSettings: "Segueix el valor predeterminat de Configuració",
    loopEditModalTitle: "Edita el bucle",
    detailEdit: "Edita",
    ...
    actionRunNow: "Executa ara",
    actionRunNowSuccessTitle: "Bucle activat",
    actionRunNowSuccessMessage: "S'està iniciant una nova iteració; revisa les sessions de sota d'aquí a un moment.",
    actionRunNowErrorTitle: "No s'ha pogut executar el bucle",
    ...
    loopBootstrapSlashCommandPresetsLabel: "Skills habituals",
    loopBootstrapSlashCommandPresetNone: "Cap",
    ...
    loopIssueHintToggleShow: "💡 Sobre escriure resultats al Git",
    loopIssueHintToggleHide: "Amaga consell",
    webhookIssueHint: "Have the Agent run `happy issue comment <n> --body \"…\"` or `issue close <n>` before exiting — token is already in env.",
    webhookIssueHintToggleShow: "💡 Sobre comentar a l'Issue",
    webhookIssueHintToggleHide: "Amaga consell",
  },
  ...
  settings: {
    ...
    appLockSubtitle: "Cal un PIN o biometria per obrir l'app",
  ...
  settingsFeatures: {
    ...
    scoringModel: "Model de puntuació",
    scoringModelDescription: "Substitueix el model LLM usat per a la puntuació de rellevància d'opcions per proveïdor. Deixa buit per als valors predeterminats (Anthropic → Haiku, OpenAI → GPT-4o-mini).",
    scoringModelProvider: "Model {{provider}}",
    scoringModelPlaceholder: "Predeterminat",
  ...
  newSession: {
    ...
    sessionLabel: {
      title: "Etiqueta de sessió (opcional)",
      namePlaceholder: "Nom de la sessió (p. ex. database-work, api-changes)",
      tagsPlaceholder: "Etiquetes separades per comes (p. ex. backend, auth)",
    },
  },
  ...
  session: {
    ...
    pastedContent: "Contingut enganxat",
    ...
    queuePausedWithCount: ({ n }: { n: number }) => `En pausa · ${n} missatge${n === 1 ? "" : "s"} en cua`,
    sendNow: "Envia ara",
    pauseQueue: "Atura la cua",
    resumeQueue: "Reprèn",
    queuedMessagePreview: "Vista prèvia",
    editQueuedMessage: "Edita el missatge",
    editMode: "Edita",
    saveChanges: "Desa",
    saveAndSendNow: "Desa i envia",
    cancelEdit: "Cancel·la",
    queueItemNotFound: "Aquest missatge ja s'ha enviat o s'ha eliminat i no es pot desar.",
    saveAndSendFailed: "No s'ha pogut enviar el missatge editat. S'ha mantingut a la cua perquè puguis tornar-ho a provar.",
    imagesCount: ({ n }: { n: number }) => `${n} imatge${n === 1 ? "" : "s"}`,
    charsCount: ({ n }: { n: number }) => `${n} caràcter${n === 1 ? "" : "s"}`,
    ...
    codeExpandLines: ({ n }: { n: number }) => `Expandir (${n} línies)`,
    ...
    loadOlderMessages: "Carregar missatges anteriors",
  },
  ...
  sessionInfo: {
    ...
    worktreeActivity: "Activitat de worktree",
    worktreeCreated: "Worktree creat",
    worktreeRemoved: "Worktree eliminat",
    recentFileChanges: "Canvis recents en fitxers",
    fileEventAdd: "Afegit",
    ...
    exportTranscript: "Exportar transcripció",
    exportTranscriptSubtitle: "Copiar missatges de sessió com a JSONL al porta-retalls",
    exportTranscriptSuccess: "Transcripció copiada al porta-retalls",
    exportTranscriptFailed: "Error en exportar la transcripció",
    exportTranscriptEmpty: "No hi ha missatges per exportar",
  },
  ...
  sidePanel: {
    ...
    sessionCode: "Codi",
    sessionContext: "Context de sessió",
    files: "Fitxers",
    changes: "Canvis",
  ...
  settingsAppLock: {
    ...
    enableSubtitle: "Cal un PIN per obrir l'app en aquest dispositiu",
    changePin: "Canvia el PIN",
    biometric: "Desbloqueja amb biometria",
    biometricSubtitle: "Fes servir Face ID, Touch ID o l'empremta per desbloquejar",
    timeout: "Demana el PIN",
    timeoutSubtitle: "Tria quant de temps pot estar l'app en segon pla abans de tornar-se a bloquejar.",
    timeoutImmediate: "Immediatament",
    timeout30s: "Després de 30 segons",
    timeout1m: "Després d'1 minut",
    timeout5m: "Després de 5 minuts",
    timeoutNever: "Mai",
    lockNow: "Bloqueja ara",
    footer: "El bloqueig de l'app controla l'accés a l'app només en aquest dispositiu. No canvia el xifratge d'extrem a extrem del teu compte.",
    setupTitle: "Defineix el PIN",
    setupEnterNew: "Introdueix un PIN nou",
    setupConfirm: "Confirma el PIN",
    setupHint: "Tria un PIN de 6 dígits",
    setupMismatch: "Els PIN no coincideixen. Torna-ho a provar.",
    unlockTitle: "Introdueix el PIN",
    unlockPrompt: "Introdueix el PIN per desbloquejar",
    incorrect: "PIN incorrecte",
    lockedOut: ({ seconds }: { seconds: number }) => `Massa intents. Torna-ho a provar d'aquí a ${seconds} s`,
    biometricPrompt: "Desbloqueja Happy",
    biometricButton: "Usa la biometria",
    forgotPin: "Has oblidat el PIN?",
    forgotTitle: "Restablir el bloqueig de l'app?",
    forgotMessage: "Per restablir el PIN, es tancarà la sessió. Torna a iniciar sessió per definir-ne un de nou; les teves dades estan segures.",
    forgotConfirm: "Tanca la sessió",
    disableTitle: "Desactivar el bloqueig de l'app?",
    disableMessage: "Ja no caldrà cap PIN ni biometria per obrir l'app en aquest dispositiu.",
  ...
  machine: {
    ...
    automationPipelineAllIdle: "Tot inactiu",
    automationPipelineAllDone: "Tot completat",
    ...
    agentLoopMaxUsdPerRun: "Pressupost màxim per execució (USD)",
    agentLoopMaxUsdPerRunPlaceholder: "ex. 1,00",
    agentLoopMaxUsdPerRunInvalid: "El pressupost per execució ha de ser un nombre positiu",
    agentLoopMaxUsdPerDay: "Pressupost màxim diari (USD)",
    agentLoopMaxUsdPerDayPlaceholder: "ex. 5,00",
    agentLoopMaxUsdPerDayInvalid: "El pressupost diari ha de ser un nombre positiu",
    agentLoopTotalCostUsd: "Cost total",
    agentLoopTodayCostUsd: "Cost d'avui",
    agentLoopLastRunCostUsd: "Cost de l'última execució",
  ...
  tasks: {
    ...
    worktreeIsolation: "Aïllament Worktree",
    worktreeIsolationDesc: "Crea un worktree Git dedicat per a aquesta tasca perquè el directori de treball actual quedi intacte.",
    statusQueued: "Queued",
  ...
  triggers: {
    ...
    profileSection: "Perfil de backend d'IA",
  ...
  dynamicWorkflows: {
    ...
    statusFailed: "Fallit",
    title: "Fluxos",
    empty: "Encara no hi ha fluxos. Executa `happy workflow run <spec.json>`.",
    stepCount: ({ count }: { count: number }) => `${count} passos`,
    wave: ({ index }: { index: number }) => `Onada ${index}`,
  },
  ...
  githubPr: {
    ...
    truncated: "… diff truncat (massa gran)",
  },
  ...
  gitHosts: {
    ...
    webhookProfileLabel: "Perfil de backend d'IA",
    webhookProfileDefault: "Per defecte (configuració del projecte)",
  },
  ...
  projects: {
    ...
    tabTraces: "Rastres",
    tracesEmpty: "Sense trucades d'eines",
    tracesEmptySubtitle: "Les trucades d'eines apareixeran aqu\u00ed durant les sessions actives",
    tracesNoSession: "Sense sessi\u00f3 activa",
    ...
    knowledgeFilterSummary: "Resum de sessió",
    knowledgeFilterRepoMap: "Mapa del repositori",
    ...
    knowledgeLifecycleTrendHint: "Llisca per veure detalls diaris",
    ...
    knowledgeConfigModeAutoHint: "Fins a 5 entrades classificades per rellevància de paraules clau. Millor equilibri entre context i cost de tokens",
    knowledgeConfigModeFullHint: "Fins a 20 entrades per sessió. Més context, però més consum de tokens",
    knowledgeConfigModeMinimalHint: "Només el perfil del projecte (stack, convencions). Sense entrades individuals",
    knowledgeConfigSensitivity: "Sensibilitat de recollida",
    knowledgeConfigSensitivityConservativeHint: "Extracció cada 5 torns valuosos o 60 min. Menys entrades, però més qualitat",
    knowledgeConfigSensitivityBalancedHint: "Extracció cada 3 torns valuosos o 30 min. Equilibri entre cobertura i soroll",
    knowledgeConfigSensitivityAggressiveHint: "Extracció després de cada torn valuós (màx. 10 min). Més entrades, però més soroll",
    knowledgeConfigCollection: "Activadors de recollida",
    knowledgeConfigTrackFileEdits: "Rastrejar edicions de fitxers",
    knowledgeConfigTrackFileEditsHint: "Quan l'IA crea o modifica fitxers → marca aquell torn com a valuós. S'envia cada 3 torns al servidor, no per cada fitxer",
    knowledgeConfigTrackTokens: "Rastrejar anàlisi profunda",
    knowledgeConfigTrackTokensHint: "Quan un torn sense edició de fitxers té >1500 tokens de sortida (raonament profund, planificació) → també es marca com a valuós",
    knowledgeConfigSummary: "Resum de sessió",
    knowledgeConfigSummaryHint: "Quan la sessió acaba amb ≥2 torns valuosos → genera automàticament un resum. Refinat per IA",
    ...
    knowledgeConfigMergeHint: "Cerca entrades amb ≥75% similitud, fusiona 2-5 per clúster (màx. 5 clústers/execució). Les fonts passen a 'reemplaçades'. Cada 6 hores",
    ...
    ciStatus: "Estat de CI",
    ciStatusEmpty: "Cap execució de CI encara. Configura un webhook de GitHub per veure l'estat de la compilació aquí.",
  },
  project: {
    segments: {
      board: "Tauler",
  ...
  diagnostics: {
    ...
    smartClean: "Neteja intel·ligent",
    smartCleanEmpty: "No s'han detectat sessions obsoletes",
    smartCleanConfirmTitle: "Netejar sessions obsoletes",
    smartCleanConfirmMessage: ({ count }: { count: number }) =>
      `Terminar ${count} sessió${count !== 1 ? "ns" : ""} obsoleta${count !== 1 ? "s" : ""}?`,
    smartCleanSuccess: ({ killed }: { killed: number }) =>
      `Netejades ${killed} sessió${killed !== 1 ? "ns" : ""} obsoleta${killed !== 1 ? "s" : ""}`,
    smartCleanFailed: "Error en netejar les sessions obsoletes",
  ...
  supervisor: {
    ...
    dimPrReview: "Revisió de codi PR",
    dimPrReviewNote: "Seguretat, qualitat i cobertura de proves dels canvis del PR",
    ...
    autoLoopSection: "Inici automàtic per regressió de salut",
    autoLoopEnabled: "Activa l'auto-loop",
    autoLoopDesc: "Inicia automàticament un loop de supervisor quan una anàlisi informi d'un health score igual o superior al llindar",
    autoLoopThreshold: "Llindar de salut",
    autoLoopThresholdHint: ({ value }: { value: number }) => `L'auto-loop es dispara quan healthScore ≥ ${value}. Més alt = menys saludable.`,
    autoLoopDebounce: "Refredament (hores)",
    autoLoopDebounceHint: ({ hours }: { hours: number }) => `Esperar ${hours}h entre auto-arrencades en aquest projecte`,
    autoLoopDebounceHintOff: "Sense refredament — l'auto-loop es dispara a cada finalització elegible (mode de prova)",
    autoLoopResetButton: "Reiniciar refredament ara",
    autoLoopResetTitle: "Reiniciar el refredament de l'auto-loop?",
    ...
    loopConfigMaxFailures: "Màx. fallades consecutives",
    loopConfigMaxFailuresHint: ({ count }: { count: number }) => `El bucle s'atura després de ${count} execucions fallides seguides`,
    loopConfigHealthTarget: "Objectiu de salut",
    loopConfigHealthTargetHint: ({ value }: { value: number }) => `Surt quan healthScore baixi a ${value} o menys`,
    loopConfigHealthTargetHintOff: "Sense objectiu de salut — el bucle sortirà per no_new_actions / goal_achieved / max_iterations / límit de cost",
    loopConfigDuration: "Límit de temps",
    loopConfigDurationHint: ({ hours }: { hours: number }) => `El bucle es completa forçosament després de ${hours}h amb motiu timeout`,
    loopConfigEmptyIters: "Confirmació de convergència",
    loopConfigEmptyItersHint: ({ count }: { count: number }) => `El bucle surt amb «objectiu assolit» després de ${count} anàlisis buides consecutives`,
    loopConfigEmptyItersHintLegacy: "El bucle surt després de la primera anàlisi buida (legacy)",
  ...
  competitorResearch: {
    ...
    dim_integrationEffort: "Complexitat d'Integració",
    dim_integrationEffort_note: "Esforç per adoptar funcions de competidors en aquest codi",
    dim_codeReusability: "Reutilització de Codi",
    dim_codeReusability_note: "Patrons, APIs, algorismes reutilitzables dels competidors",
  ...
  projectConfig: {
    sectionSupervisor: "Monitor de salut",
    sectionResearch: "Recerca de competidors",
    sectionKnowledge: "Base de coneixement",
    sectionNotifications: "Notificacions i perfil",
    sectionIntegrations: "Integracions i webhook",
    supervisorMode: "Modalitat",
    modeSuggest: "Suggerir",
    modeSemiAuto: "Semiautomàtic",
    modeAuto: "Automàtic",
    supervisorSchedule: "Programació",
    supervisorDimensions: "Paràmetres",
    dimensionsEnabled: "habilitat",
    supervisorPush: "Disparador push",
    researchDimensions: "Paràmetres",
    researchDirection: "Direcció",
    researchRules: "Regles",
    rulesLines: "línies",
    researchHint: "Els valors predeterminats de recerca es configuren aquí. Les substitucions per execució es troben a la pestanya Recerca.",
    knowledgeNotAvailable: "Configuració de coneixement no disponible. Sincronitzeu primer el projecte amb el servidor.",
    notificationsEnabled: "Notificacions",
    defaultProfile: "Perfil d'IA",
    profileDefault: "Predeterminat",
    webhookEvents: "ESDEVENIMENTS DE WEBHOOK",
    webhookNoEvents: "Encara no hi ha esdeveniments de webhook",
    viewAll: "Veure-ho tot",
    machineTriggers: "Disparadors de màquina",
    movedToConfigHint: "La configuració s'ha mogut a la pestanya Config",
    sectionContextMd: "Context del projecte",
    contextMdDesc: "S'injecta automàticament a cada nova sessió d'agent",
    contextMdEdit: "Editar CONTEXT.md",
    contextMdNoSession: "Sense sessió activa — inicieu una sessió per editar",
    contextMdTitle: "Editar context del projecte",
    contextMdSave: "Desar",
    contextMdSaved: "Desat",
    contextMdSaveError: "Error en desar",
    contextMdPlaceholder: "Descriu el teu projecte: pila tecnològica, convencions, decisions arquitectòniques clau...",
    contextMdHint: "Emmagatzemat a .happy/CONTEXT.md al repositori del teu projecte.",
  },
  suggestions: {
    refresh: "Actualitzar",
  },
  claudeControl: {
    cost: {
      label: "Cost de la sessió",
      loading: "Calculant cost…",
      error: "Cost no disponible",
    },
    version: {
      remoteCli: "Claude Code remot",
      happyCli: "Happy CLI",
      unknown: "Desconegut",
    },
    color: {
      title: "Color de la sessió",
    ...
    fileViewer: {
      ...
      close: "Tancar",
      loading: "Carregant…",
      truncated: "Truncat a 1 MiB",
      deniedBlacklistedPath: "Ruta bloquejada per la política de seguretat del CLI",
      deniedPermissionDenied: "Accés denegat per Claude Code",
      deniedTooLarge: "Fitxer massa gran",
      deniedNotFound: "Fitxer no trobat",
      deniedError: "No s'ha pogut llegir el fitxer",
    },
    mcp: {
      title: "Invocar eina MCP",
      stepSelect: "1. Seleccionar eina",
      stepConfirm: "2. Confirmar",
      reviewHeading: "Revisar abans d'invocar",
      confirmCheckbox: "Entenc que això executarà una eina MCP directament",
      invoke: "Invocar",
      result: "Resultat",
      errorNotWhitelisted: "Servidor MCP no a la llista blanca del CLI remot",
      errorServerUnavailable: "Servidor MCP no disponible",
      errorToolNotFound: "Eina no trobada al servidor",
      errorInvalidArguments: "Arguments no vàlids",
      errorPermissionDenied: "Permís denegat",
      errorSdkNotImplemented: "Esperant Claude Agent SDK — el runtime mcp_call encara no està disponible",
    ...
    contextUsage: {
      ...
      percentage: "Usat {pct}%",
      model: "Model d'IA: {model}",
      memoryFiles: "Fitxers de memòria",
      mcpTools: "Eines MCP",
      noMemoryFiles: "Cap carregat",
      noMcpTools: "Cap carregat",
      detailLoading: "Carregant contingut…",
      detailError: "No s'ha pogut carregar el contingut",
      detailItems: "{n} elements",
      ...
      subcatRedirectedContextDesc: "Context de cicles de compactació anteriors o redirigit de sub-agents",
  ...
  world: {
    title: "Món",
    subtitle: "Entra a l'espai de treball agent global",
    exitWorld: "Sortir del món",
    streamMode: "Flux d'esdeveniments",
    noEvents: "Encara no hi ha esdeveniments",
    emptyTitle: "La matriu és silenciosa",
    emptyDescription: "Els programes apareixeran aquí mentre s'executen. Inicia una sessió o activa una tasca per veure el món prendre vida.",
    filterAll: "Tots",
    definitionPanel: "Definició del món",
    narrative: "Narrativa",
    laws: "Lleis",
    policy: "Política",
    notSet: "No definit",
    narrativePlaceholder: "Descriu la direcció i els objectius actuals...",
    chainMode: "Cadenes",
    agentMode: "Agents actius",
    noAgents: "Sense agents actius",
    agentModeEmptyDescription: "Els agents apareixeran aquí quan les sessions estiguin actives en màquines connectades.",
    agentIdle: "Inactiu",
    noChainResults: "Cap cadena coincideix amb la cerca",
    policyDescDisabled: "Només manual — sense accions automatitzades",
    policyDescSuggest: "Suggereix els propers passos, espera la teva confirmació",
    policyDescSemiAuto: "Gestiona automàticament les accions rutinàries, escala les excepcions",
    policyDescAuto: "Totalment autònom — actua en totes les decisions sense esperar",
    inspector: "Detalls de l'esdeveniment",
    ...
    eventTime: "Hora",
    eventSource: "Font",
    eventMachine: "Màquina",
    eventSession: "Sessió",
    eventId: "ID d'esdeveniment",
    actionApprove: "Aprovar",
    actionSkip: "Saltar",
    actionRead: "Marcar com a llegit",
    actionDismiss: "Descartar",
    actionRetry: "Reintentar",
    actionDone: "Fet",
    eventProject: "Projecte",
    openIn: "Obrir a",
    openKnowledge: "Obrir coneixement",
    actions: "Accions",
    densityMode: "Densitat",
    densitySystem: "Sistema",
    densityEvents: "esdeveniments",
    densityActive: "actiu",
    densityViewStream: "Veure al flux",
    densityEmpty: "Encara no hi ha activitat",
    densityEmptyDesc: "Els projectes apareixeran aquí quan es produeixin esdeveniments.",
    densityTotal: "en total",
    densityRecent: "últ. 30 min",
    densityLastActivity: "darrera activitat",
    emptyFilterTitle: "Sense esdeveniments coincidents",
    emptyFilterDesc: "Cap esdeveniment coincideix amb el filtre actual. Prova d'esborrar-lo.",
    emptyClearFilter: "Esborrar filtre",
    emptyActionNewSession: "Nova sessió",
    emptyActionQueueTask: "Encuar tasca",
    emptyQuickStart: "Escriu / per a les ordres",
  },
} as const;
