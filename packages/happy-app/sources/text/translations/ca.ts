...
export const ca: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    worldModel: "Model del Món",
    worldModelEnabled: "Pestanyes del model del món visibles als projectes",
    worldModelDisabled: "Pestanyes del model del món amagades",
    ...
    knowledgeBaseMode: "Mode de base de coneixement",
    knowledgeBaseModeAuto: "Auto — injectar context segons calgui",
    knowledgeBaseModeFull: "Complet — sempre injectar tot el context",
    knowledgeBaseModeMinimal: "Mínim — injectar només l'essencial",
    knowledgeBaseSensitivity: "Sensibilitat de recollida",
    knowledgeBaseSensitivityConservative: "Conservador — 5 torns / 60 min, eines > 8, tokens > 800",
    knowledgeBaseSensitivityBalanced: "Equilibrat — 3 torns / 30 min, eines > 5, tokens > 500",
    knowledgeBaseSensitivityAggressive: "Agressiu — 1 torn / 10 min, eines > 3, tokens > 200",
    knowledgeBaseTrackFileEdits: "Rastrejar edicions de fitxers",
    knowledgeBaseTrackFileEditsSubtitle: "Recollir coneixement en crear o editar fitxers",
    knowledgeBaseTrackToolCalls: "Rastrejar crides a eines",
    knowledgeBaseTrackToolCallsSubtitle: "Recollir coneixement amb moltes invocacions",
    knowledgeBaseTrackTokens: "Rastrejar sortida de tokens",
  ...
  machine: {
    ...
    automationGuardianReuseCountHint: "Reutilitzades en lloc de crear-ne de noves",
    automationGuardianReuseRateHint: "Taxa de reutilització exitosa",
    automationGuardianResetCountHint: "Esborrades i reiniciades",
    ...
    automationGuardianUsageHint: "Mostra amb quina freqüència s'ha reutilitzat, recordat o reiniciat cada clau Guardian.",
    automationClearAuditHint: "Elimina els registres locals d'auditoria mantenint intactes les tasques actuals i l'estat de Guardian.",
    automationAuditHint: "Esdeveniments recents de nivell màquina sobre decisions d'automatització, continuïtat Guardian i anomalies.",
    automationTimelineHint: "Vista cronològica de les fites recents del cicle de vida de les tasques.",
    automationAlertsHint: "Mostra primer els problemes que probablement necessiten atenció manual, com anomalies o Guardians que cal recuperar.",
    ...
    automationOverviewHint: "Fes servir aquesta pàgina per entendre les tasques actuals, la continuïtat Guardian, la salut dels loops i els senyals d'auditoria abans d'entrar en detall.",
    ...
    automationSearchHint: "Cerca per nom de tasca, clau Guardian, ID de sessió, ID de loop, ID de projecte o text d'error.",
    ...
    automationAuditFiltersHint: "Filtra els esdeveniments d'auditoria per anomalies, continuïtat Guardian, cicle de vida de la tasca o esdeveniments de recuperació.",
    automationGuardianFiltersHint: "Diferencia els Guardians actualment adjunts, persistits per a una reutilització posterior o recuperats després de tornar-se a connectar.",
    ...
    automationSectionGuardians: "Estat de continuïtat de les sessions",
    automationSectionAuditStats: "Mètriques de salut d'auditoria",
    automationSectionGuardianUsage: "Historial de reutilització per guardian",
    ...
    agentLoopBootstrapHint: "Escaneja els repositoris d'aquesta màquina, genera plans de loop i materialitza'ls en bloc.",
    agentLoopBootstrapEmpty: "Encara no hi ha repositoris preparats per al bootstrap — escaneja aquesta màquina per descobrir candidats",
  ...
  world: {
    ...
    categoryProcess: "Procés",
    categoryOps: "Operacions",
    ...
    deleteLawConfirmBody: "Esteu segur que voleu eliminar aquesta llei?",
    dashboardTitle: "Resum del món",
    autonomyScore: "Autonomia",
    autonomyScoreDesc: "Decisions auto-resoltes en els últims 30 dies",
    activeGroups: "Grups actius",
    pendingDecisions: "Decisions pendents",
    goalsOverview: "Objectius",
    goalsActive: "Actius",
    goalsCompleted: "Completats",
    goalsBlocked: "Bloquejats",
    recentDecisions: "Decisions recents",
    agentMessages: "Missatges d'Agent",
    noDataYet: "Encara no hi ha dades del món",
    noDataHint: "Configureu narrativa, lleis i rols per habilitar el World Model",
    lawCount: "Lleis",
    lawSuggestions: "Suggeriments de lleis",
    conflicts: "Conflictes",
    fullyAutonomous: "Totalment autònom",
    needsAttention: "Necessita atenció",
    notApplicable: "N/A",
    autonomyDecided: "decidit",
    autonomyAuto: "auto",
    ...
    generateSuccess: "Elements del món generats — revisa i desa",
    generateError: "No s'han pogut generar els elements del món",
    generateConfirmTitle: "Sobreescriure el contingut existent?",
    generateConfirmBody: "Això reemplaçarà la narrativa i les lleis actuals amb contingut autogenerat. Pots revisar abans de desar.",
    generateSkipped: "Omès (ja existeix)",
    generatePartialError: "Errors parcials",
    modeAuto: "Inici intel·ligent",
    modeCustom: "Personalitzat",
    modeAutoHint: "Completa automàticament només les parts que falten — la narrativa, lleis, rols i objectius existents es conservaran.",
    modeCustomHint: "Descriu aquest món o enganxa context, i generarem tots els elements del món basats en la teva descripció.",
    customPromptPlaceholder: "Descriu la visió d'aquest món, stack tecnològic, estructura de l'equip, o enganxa un README...",
    ...
    generateAutoAction: "Inicialitza món",
    generateCustomAction: "Genera des de la descripció",
    goalHealth: "Salut de l'objectiu",
    avgHealthScore: "Puntuació mitjana",
    worldAlias: "Nom del món",
    worldAliasDescription: "Nom personalitzat per a aquest món",
    worldAliasNotSet: "No establert",
    worldAliasPromptTitle: "Nom del món",
    worldAliasPromptMessage: "Introdueix un nom personalitzat per a aquest món",
    worldTerminate: "Acabar el món",
    worldTerminateConfirm: "Estàs segur que vols acabar amb aquest món? S'amagarà de la llista.",
    worldRevive: "Reviure el món",
    worldReviveConfirm: "Estàs segur que vols reviure aquest món?",
  },
  suggestions: {
    suggestedNextSteps: "Propers passos suggerits",
    noSuggestions: "Cap suggeriment ara mateix",
    noSuggestionsHint: "Els suggeriments apareixeran quan els objectius estiguin bloquejats o les tasques fallin",
    refresh: "Actualitzar",
    refreshing: "Actualitzant...",
    accept: "Acceptar",
    dismiss: "Descartar",
    acceptConfirmTitle: "Acceptar suggeriment",
  ...
  governance: {
    title: "Governança",
    policyMode: "Mode d'autonomia",
    policyModeDesc: "Controla com actua el món de forma autònoma",
    modeDisabledDesc: "Sense accions automàtiques",
    modeSuggestDesc: "Només suggeriments, tu decideixes",
    modeSemiAutoDesc: "Auto-acceptar tasques segures",
    modeAutoDesc: "Auto-acceptar tasques i objectius",
    autoAcceptTypes: "Tipus d'auto-acceptació",
    typeTask: "Tasques",
    typeGoal: "Objectius",
    typeDecision: "Decisions (amb precedent)",
    auditLog: "Auditoria d'automatització",
    auditEmpty: "Encara no hi ha accions auto-acceptades",
    auditVeto: "Vetar",
    auditVetoConfirmTitle: "Vetar acció automàtica",
    auditVetoConfirmBody: "Això cancel·larà l'acció executada automàticament. Esteu segur?",
    auditVetoed: "Acció vetada",
    auditVetoFailed: "No s'ha pogut vetar",
    auditWindowExpired: "Finestra de vet expirada",
    auditAutoResolved: "Auto-resolt",
    auditAutoAccepted: "Auto-acceptat",
  },
  collaboration: {
    title: "Col·laboració de grups",
    noBlocks: "Cap bloqueig actiu",
    blockedChains: "Cadenes bloquejades",
    openConflicts: "Conflictes oberts",
    pendingDecisions: "Decisions pendents",
    groupActivity: "Activitat de grups",
    waitingFor: ({ role }: { role: string }) => `Esperant ${role}`,
    handoffs: "Transferències",
    reviewRequests: "Revisions",
    dependencyBlocked: "Bloquejat",
  ...
  roles: {
    ...
    dutiesCount: ({ count }: { count: number }) => `${count} ${count === 1 ? "deure" : "deures"}`,
    skillsCount: ({ count }: { count: number }) => `${count} ${count === 1 ? "habilitat" : "habilitats"}`,
  ...
  members: {
    ...
    emptyState: "Encara no hi ha membres de l'equip. Afegeix membres per habilitar la presa de decisions col·laborativa.",
    usernameLabel: "Nom d'usuari",
    usernamePlaceholder: "Introdueix el nom d'usuari per convidar",
    roleLabel: "Nivell de permís",
    roleOwner: "Propietari",
    roleAdmin: "Administrador",
    roleMember: "Membre",
    roleObserver: "Observador",
    expertiseLabel: "Especialitat",
    expertisePlaceholder: "Afegir etiqueta d'especialitat...",
    lawAuthorityLabel: "Autoritat de lleis",
    lawCreate: "Crear",
    lawSuggest: "Només suggerir",
    lawReadonly: "Només lectura",
    decisionScopeLabel: "Abast de decisions",
    decisionAll: "Totes les decisions",
    decisionAssigned: "Només assignades",
    decisionNone: "Cap",
    goalAuthorityLabel: "Autoritat d'objectius",
    goalCreate: "Crear",
    goalSuggest: "Només suggerir",
    goalReadonly: "Només lectura",
    notifyLevelLabel: "Notificacions",
    notifyAll: "Totes",
    notifyCritical: "Només crítiques",
    notifyAssigned: "Només assignades",
    notifyNone: "Cap",
    availabilityLabel: "Disponibilitat",
    availabilityActive: "Actiu",
    availabilityAway: "Absent",
    availabilityDelegate: "Delegar",
    delegateToLabel: "Delegar a",
    saved: "Membre desat",
    saveError: "Error en desar el membre",
    removed: "Membre eliminat",
    removeConfirmTitle: "Eliminar membre",
    removeConfirmBody: "Estàs segur que vols eliminar aquest membre? Perdrà l'accés al model del món del projecte.",
    cannotRemoveOwner: "No es pot eliminar el propietari del projecte",
    memberAlreadyExists: "Aquest usuari ja és membre",
    userNotFound: "Usuari no trobat",
  ...
  goals: {
    title: "Objectius",
    createGoal: "Nou objectiu",
    goalTitle: "Títol",
    goalTitlePlaceholder: "Què vols aconseguir?",
    goalDescription: "Descripció",
    goalDescriptionPlaceholder: "Proporciona més detalls sobre aquest objectiu...",
    goalPriority: "Prioritat",
    goalDeadline: "Data límit",
    goalMachine: "Màquina",
    statusPlanning: "Planificant",
    statusPlanningPending: "Planning (pending decomposition)",
    statusPlanningRunning: "Planning (decomposing)",
    statusInProgress: "En progrés",
    ...
    priorityLow: "Baix",
    emptyGoals: "Encara no hi ha objectius",
    emptyGoalsHint: "Crea un objectiu i el sistema el descompondrà automàticament en tasques",
    autoDecompose: "Descompondre automàticament en tasques",
    tasks: ({ count }: { count: number }) => `${count} ${count === 1 ? "tasca" : "tasques"}`,
    subGoals: ({ count }: { count: number }) => `${count} ${count === 1 ? "subobjectiu" : "subobjectius"}`,
    cancelGoal: "Cancel·lar objectiu",
    cancelGoalConfirm: "Això cancel·larà totes les tasques actives. Continuar?",
    plannerWorking: "El planificador està descomponent...",
    ...
    decomposeTriggered: "Descomposició iniciada",
    decomposeError: "Error en iniciar descomposició",
    viewSession: "Veure sessió",
    taskIndex: ({ index }: { index: number }) => `Tasca #${index}`,
    progress: ({ value }: { value: number }) => `${value}%`,
    created: "Objectiu creat",
    createError: "Error en crear l'objectiu",
    cancelled: "Objectiu cancel·lat",
    deleteGoal: "Eliminar objectiu",
    deleteGoalConfirm: "Eliminar aquest objectiu permanentment?",
    deleted: "Objectiu eliminat",
    healthScore: "Salut",
    healthCritical: "Crític",
    healthWarning: "No saludable",
    healthHealthy: "Saludable",
    layerStrategic: "Estratègic",
    layerOperational: "Operatiu",
    layerExecution: "Execució",
    replan: "Replanificar",
    replanConfirm: "Cancel·lar les tasques actives i re-descompondre aquest objectiu?",
  ...
  decision: {
    ...
    autoResolved: "Resolt automàticament",
    adjudicateError: "No s'ha pogut adjudicar la decisió",
    assignedTo: "Assignat",
    opinions: "Opinions",
    submitOpinion: "Enviar opinió",
    opinionSubmitted: "Opinió enviada",
    opinionConflict: "Opinions en conflicte — escalat a l'administrador",
