...
export const ca: TranslationStructure = {
  ...
  machine: {
    ...
    automationQueuedHint: "Espera per ser assignada a una sessió.",
    automationRunningHint: "S'està executant ara mateix o està a punt de ser assignada.",
    automationGuardiansHint: "Sessions de continuïtat desades disponibles per reutilitzar o tornar a adjuntar.",
    ...
    automationLoopsTotalHint: "Tots els loops configurats actualment en aquesta màquina.",
    automationLoopsActiveHint: "Loops que encara es poden executar automàticament quan s'activen triggers o plans.",
    automationLoopsBlockedHint: "Loops aturats per errors, política o una parada manual de seguretat.",
    automationLoopsPausedHint: "Loops actualment desactivats i esperant ser represos.",
    automationLoopsPendingEventsHint: "Loops amb esdeveniments en cua que encara no s'han processat.",
    automationLoopsPolicyStoppedHint: "Loops aturats recentment per la política o per la lògica de protecció.",
    automationOpenLoopsHint: "Obre la configuració, els triggers i l'estat d'execució dels loops d'aquesta màquina.",
    automationTotalAuditEventsHint: "Nombre total de registres locals d'auditoria d'automatització emmagatzemats en aquesta màquina.",
    automationGuardianReuseCountHint: "Quantes vegades s'ha reutilitzat una sessió Guardian existent en lloc de començar de zero.",
    automationGuardianReuseRateHint: "Percentatge d'execucions elegibles que han reutilitzat correctament una sessió Guardian.",
    automationGuardianResetCountHint: "Quantes vegades s'ha hagut d'esborrar i reiniciar la continuïtat desada de Guardian.",
    automationSessionReattachedCountHint: "Quantes sessions s'han pogut tornar a adjuntar després d'una interrupció o reinici.",
    automationWatchdogStopsHint: "Quantes vegades el watchdog ha aturat forçosament una sessió per seguretat.",
