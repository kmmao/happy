...
export const ca: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    knowledgeBaseSensitivityConservative: "Conservador — menys però de més qualitat",
    knowledgeBaseSensitivityBalanced: "Equilibrat — llindars predeterminats",
    knowledgeBaseSensitivityAggressive: "Agressiu — capturar més coneixement",
