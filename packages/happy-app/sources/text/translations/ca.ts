...
export const ca: TranslationStructure = {
  ...
  settingsVoice: {
    ...
    livekitConfigDescription: "Opcional: proporciona el teu propi LiveKit Cloud API Key i Secret. L’ús es facturarà al teu compte de LiveKit en lloc del del servidor.",
