...
export const pt: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    knowledgeBaseSensitivityConservative: "Conservador — menos mas de maior qualidade",
    knowledgeBaseSensitivityBalanced: "Equilibrado — limiares padrão",
    knowledgeBaseSensitivityAggressive: "Agressivo — capturar mais conhecimento",
