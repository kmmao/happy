...
export const pt: TranslationStructure = {
  ...
  projects: {
    ...
    knowledgeConfigModeAutoHint: "Decide automaticamente quanto contexto injetar com base na relevância",
    knowledgeConfigModeFullHint: "Sempre injeta todo o conhecimento disponível no contexto da sessão",
    knowledgeConfigModeMinimalHint: "Injeta apenas conhecimento crítico — convenções e avisos",
    knowledgeConfigSensitivity: "Sensibilidade de coleta",
    knowledgeConfigSensitivityConservativeHint: "Coleta apenas descobertas e decisões de alta confiança",
    knowledgeConfigSensitivityBalancedHint: "Coleta a maioria das descobertas com filtragem moderada",
    knowledgeConfigSensitivityAggressiveHint: "Coleta tudo — incluindo observações de baixa confiança",
    knowledgeConfigCollection: "Gatilhos de coleta",
    knowledgeConfigTrackFileEdits: "Rastrear edições de arquivos",
    knowledgeConfigTrackFileEditsHint: "Registra conhecimento quando arquivos são criados ou modificados",
    knowledgeConfigTrackToolCalls: "Rastrear chamadas de ferramentas",
    knowledgeConfigTrackToolCallsHint: "Registra conhecimento das invocações de ferramentas e seus resultados",
    knowledgeConfigTrackTokens: "Rastrear saída de tokens",
    knowledgeConfigTrackTokensHint: "Registra conhecimento das respostas do assistente de IA",
    knowledgeConfigLifecycle: "Ciclo de vida",
    knowledgeConfigRefine: "Refinamento por IA",
    knowledgeConfigRefineHint: "Usa IA para melhorar, deduplicar e enriquecer novas entradas",
    knowledgeConfigDecay: "Arquivo automático",
    knowledgeConfigDecayHint: "Arquiva automaticamente entradas não acessadas há mais de 30 dias",
    knowledgeConfigMerge: "Fusão inteligente",
    knowledgeConfigMergeHint: "Busca e mescla periodicamente entradas similares usando IA",
