...
export const pl: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    worldModel: "Model świata",
    worldModelEnabled: "Karty modelu świata widoczne w projektach",
    worldModelDisabled: "Karty modelu świata ukryte",
  ...
  session: {
    ...
    progressTodoPromptVerify: ({ content }: { content: string }) =>
      `Proszę zweryfikować, czy zadanie "${content}" rzeczywiście zostało ukończone. Wypisz dowody (pliki, testy, komendy). Jeśli czegoś brakuje, wywołaj mcp__happy__update_progress, aby zmienić status z powrotem na in_progress lub pending.`,
    progressTodoPromptContinue: ({ content }: { content: string }) =>
      `Proszę teraz zająć się "${content}" (od miejsca, w którym przerwano). Gdy będą postępy, wywołuj mcp__happy__update_progress, aby aktualizować status.`,
    progressTodoPromptIssue: ({ content }: { content: string }) =>
      `Zadanie "${content}" oznaczono jako ukończone, ale moim zdaniem nie jest. Powód: [dopisz]. Sprawdź ponownie; jeśli się zgadzasz, wywołaj mcp__happy__update_progress, aby przywrócić status in_progress lub pending.`,
  ...
  world: {
    ...
    categoryProcess: "Proces",
    categoryOps: "Operacje",
    ...
    deleteLawConfirmBody: "Czy na pewno chcesz usunąć to prawo?",
    dashboardTitle: "Przegląd świata",
    autonomyScore: "Autonomia",
    autonomyScoreDesc: "Decyzje automatycznie rozwiązane w ciągu ostatnich 30 dni",
    activeGroups: "Aktywne grupy",
    pendingDecisions: "Oczekujące decyzje",
    goalsOverview: "Cele",
    goalsActive: "Aktywne",
    goalsCompleted: "Ukończone",
    goalsBlocked: "Zablokowane",
    recentDecisions: "Ostatnie decyzje",
    agentMessages: "Wiadomości Agent",
    noDataYet: "Brak danych o świecie",
    noDataHint: "Skonfiguruj narrację, prawa i role, aby włączyć World Model",
    lawCount: "Prawa",
    lawSuggestions: "Sugestie praw",
    conflicts: "Konflikty",
    fullyAutonomous: "Pełna autonomia",
    needsAttention: "Wymaga uwagi",
    notApplicable: "N/A",
    autonomyDecided: "zdecydowano",
    autonomyAuto: "auto",
    ...
    generateSuccess: "Elementy świata wygenerowane — sprawdź i zapisz",
    generateError: "Nie udało się wygenerować elementów świata",
    generateConfirmTitle: "Nadpisać istniejącą zawartość?",
    generateConfirmBody: "Obecna narracja i prawa zostaną zastąpione automatycznie wygenerowaną zawartością. Możesz sprawdzić przed zapisaniem.",
    generateSkipped: "Pominięto (dane już istnieją)",
    generatePartialError: "Częściowe błędy",
    modeAuto: "Inteligentna inicjalizacja",
    modeCustom: "Niestandardowa",
    modeAutoHint: "Automatycznie uzupełnia tylko brakujące części — istniejące narracja, prawa, role i cele zostaną zachowane.",
    modeCustomHint: "Opisz ten świat lub wklej kontekst, a wygenerujemy wszystkie elementy świata na podstawie Twojego opisu.",
    customPromptPlaceholder: "Opisz wizję tego świata, stos technologiczny, strukturę zespołu lub wklej README...",
    ...
    generateAutoAction: "Inicjalizuj świat",
    generateCustomAction: "Generuj z opisu",
    goalHealth: "Zdrowie celu",
    avgHealthScore: "Średni wynik",
    worldAlias: "Nazwa świata",
    worldAliasDescription: "Niestandardowa nazwa wyświetlana dla tego świata",
    worldAliasNotSet: "Nie ustawiono",
    worldAliasPromptTitle: "Nazwa świata",
    worldAliasPromptMessage: "Wprowadź niestandardową nazwę dla tego świata",
    worldTerminate: "Zakończ świat",
    worldTerminateConfirm: "Czy na pewno chcesz zakończyć ten świat? Zostanie ukryty z listy.",
    worldRevive: "Wskrześ świat",
    worldReviveConfirm: "Czy na pewno chcesz wskrzesić ten świat?",
  },
  suggestions: {
    suggestedNextSteps: "Sugerowane kolejne kroki",
    noSuggestions: "Brak sugestii",
    noSuggestionsHint: "Sugestie pojawią się, gdy cele zostaną zablokowane lub zadania zawiodą",
    refresh: "Odśwież",
    refreshing: "Odświeżanie...",
    accept: "Akceptuj",
    dismiss: "Odrzuć",
    acceptConfirmTitle: "Akceptuj sugestię",
    acceptConfirmBody: ({ type, title }: { type: string; title: string }) =>
      `Zostanie utworzony nowy ${type}: "${title}". Kontynuować?`,
    accepted: "Sugestia zaakceptowana",
    acceptedGeneric: "Zaakceptowano",
    acceptedManual: "Zaakceptowano ręcznie",
    acceptedAuto: "Zaakceptowano automatycznie",
    dismissed: "Sugestia odrzucona",
    evidence: "Na podstawie",
    recommendedRole: "Zalecana rola",
    typeGoal: "Goal",
    typeTask: "Task",
    typeSkill: "Skill",
    typeDecision: "Decision",
    autoAcceptReasonSafeTask: "Zaakceptowano automatycznie, ponieważ pasuje do bezpiecznej reguły następnego taska",
  ...
  governance: {
    title: "Zarządzanie",
    policyMode: "Tryb autonomii",
    policyModeDesc: "Kontroluje sposób autonomicznego działania świata",
    modeDisabledDesc: "Brak automatycznych działań",
    modeSuggestDesc: "Tylko sugestie, ty decydujesz",
    modeSemiAutoDesc: "Automatyczna akceptacja bezpiecznych zadań",
    modeAutoDesc: "Automatyczna akceptacja zadań i celów",
    autoAcceptTypes: "Typy automatycznej akceptacji",
    typeTask: "Zadania",
    typeGoal: "Cele",
    typeDecision: "Decyzje (z precedensem)",
    auditLog: "Audyt automatyzacji",
    auditEmpty: "Brak automatycznie zaakceptowanych działań",
    auditVeto: "Weto",
    auditVetoConfirmTitle: "Weto automatycznego działania",
    auditVetoConfirmBody: "To anuluje automatycznie wykonane działanie. Czy jesteś pewny?",
    auditVetoed: "Działanie zawetowane",
    auditVetoFailed: "Nie udało się zawetować",
    auditWindowExpired: "Okno weta wygasło",
    auditAutoResolved: "Auto-rozwiązane",
    auditAutoAccepted: "Auto-zaakceptowane",
  },
  collaboration: {
    title: "Współpraca grup",
    noBlocks: "Brak aktywnych blokad",
    blockedChains: "Zablokowane łańcuchy",
    openConflicts: "Otwarte konflikty",
    pendingDecisions: "Oczekujące decyzje",
    groupActivity: "Aktywność grup",
    waitingFor: ({ role }: { role: string }) => `Oczekiwanie na ${role}`,
    handoffs: "Przekazania",
    reviewRequests: "Recenzje",
    dependencyBlocked: "Zablokowany",
    chainLabel: ({ chain }: { chain: string }) => `Łańcuch: ${chain}`,
  ...
  roles: {
    ...
    dutiesCount: ({ count }: { count: number }) => `${count} obowiązk.`,
    skillsCount: ({ count }: { count: number }) => `${count} umiejętn.`,
  ...
  members: {
    ...
    emptyState: "Brak członków zespołu. Dodaj członków, aby umożliwić wspólne podejmowanie decyzji.",
    usernameLabel: "Nazwa użytkownika",
    usernamePlaceholder: "Wpisz nazwę użytkownika do zaproszenia",
    roleLabel: "Poziom uprawnień",
    roleOwner: "Właściciel",
    roleAdmin: "Administrator",
    roleMember: "Członek",
    roleObserver: "Obserwator",
    expertiseLabel: "Specjalizacja",
    expertisePlaceholder: "Dodaj tag specjalizacji...",
    lawAuthorityLabel: "Uprawnienia do reguł",
    lawCreate: "Tworzenie",
    lawSuggest: "Tylko sugestie",
    lawReadonly: "Tylko odczyt",
    decisionScopeLabel: "Zakres decyzji",
    decisionAll: "Wszystkie decyzje",
    decisionAssigned: "Tylko przypisane",
    decisionNone: "Brak",
    goalAuthorityLabel: "Uprawnienia do celów",
    goalCreate: "Tworzenie",
    goalSuggest: "Tylko sugestie",
    goalReadonly: "Tylko odczyt",
    notifyLevelLabel: "Powiadomienia",
    notifyAll: "Wszystkie",
    notifyCritical: "Tylko krytyczne",
    notifyAssigned: "Tylko przypisane",
    notifyNone: "Brak",
    availabilityLabel: "Dostępność",
    availabilityActive: "Aktywny",
    availabilityAway: "Nieobecny",
    availabilityDelegate: "Deleguj",
    delegateToLabel: "Deleguj do",
    saved: "Członek zapisany",
    saveError: "Nie udało się zapisać członka",
    removed: "Członek usunięty",
    removeConfirmTitle: "Usuń członka",
    removeConfirmBody: "Czy na pewno chcesz usunąć tego członka? Straci dostęp do modelu świata projektu.",
    cannotRemoveOwner: "Nie można usunąć właściciela projektu",
    memberAlreadyExists: "Ten użytkownik jest już członkiem",
    userNotFound: "Nie znaleziono użytkownika",
    expertiseCount: ({ count }: { count: number }) => `${count} ${count === 1 ? "tag" : "tagów"}`,
  ...
  goals: {
    ...
    createGoal: "Nowy cel",
    goalTitle: "Tytuł",
    goalTitlePlaceholder: "Co chcesz osiągnąć?",
    goalDescription: "Opis",
    goalDescriptionPlaceholder: "Podaj więcej szczegółów o tym celu...",
    goalPriority: "Priorytet",
    goalDeadline: "Termin",
    goalMachine: "Maszyna",
    ...
    priorityLow: "Niski",
    emptyGoals: "Brak celów",
    emptyGoalsHint: "Utwórz cel, a system automatycznie rozłoży go na zadania",
    autoDecompose: "Automatycznie rozłóż na zadania",
    tasks: ({ count }: { count: number }) => `${count} ${count === 1 ? "zadanie" : "zadań"}`,
    subGoals: ({ count }: { count: number }) => `${count} ${count === 1 ? "podcel" : "podcelów"}`,
    cancelGoal: "Anuluj cel",
    cancelGoalConfirm: "Wszystkie aktywne zadania zostaną anulowane. Kontynuować?",
    plannerWorking: "Planista rozkłada na części...",
    ...
    decomposeTriggered: "Dekompozycja uruchomiona",
    decomposeError: "Nie udało się uruchomić dekompozycji",
    viewSession: "Zobacz sesję",
    taskIndex: ({ index }: { index: number }) => `Zadanie #${index}`,
    progress: ({ value }: { value: number }) => `${value}%`,
    created: "Cel utworzony",
    createError: "Nie udało się utworzyć celu",
    cancelled: "Cel anulowany",
    deleteGoal: "Usuń cel",
    deleteGoalConfirm: "Usunąć ten cel na stałe?",
    deleted: "Cel usunięty",
    healthScore: "Zdrowie",
    healthCritical: "Krytyczny",
    healthWarning: "Niezdrowy",
    healthHealthy: "Zdrowy",
    layerStrategic: "Strategiczny",
    layerOperational: "Operacyjny",
    layerExecution: "Wykonawczy",
    replan: "Przeplanuj",
    replanConfirm: "Anulować aktywne zadania i ponownie rozłożyć ten cel?",
  ...
  decision: {
    ...
    autoResolved: "Rozwiązano automatycznie",
    adjudicateError: "Nie udało się podjąć decyzji",
    assignedTo: "Przypisano",
    opinions: "Opinie",
    submitOpinion: "Wyślij opinię",
    opinionSubmitted: "Opinia wysłana",
    opinionConflict: "Opinie sprzeczne — przekazano administratorowi",
