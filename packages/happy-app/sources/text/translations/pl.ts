...
export const pl: TranslationStructure = {
  ...
  settingsVoice: {
    ...
    livekitConfigDescription: "Opcjonalnie: podaj własny LiveKit Cloud API Key i Secret. Zużycie będzie rozliczane na Twoim koncie LiveKit zamiast serwerowym.",
    ...
    ttsProviderDescription: "Wybierz sposób konwersji tekstu na mowę. Bezpłatne opcje nie wymagają konfiguracji.",
    ttsProviderWebSpeech: "Web Speech API",
    ttsProviderWebSpeechDescription: "Natywny TTS przeglądarki bez kosztów — nie wymaga konta",
    ttsProviderWebSpeechNote: "Używa wbudowanego silnika zamiany tekstu na mowę urządzenia. Działa natychmiast bez konfiguracji.",
    ttsProviderEdge: "Microsoft Edge TTS",
    ttsProviderEdgeDescription: "Bezpłatny, wysokiej jakości chmurowy TTS od Microsoft",
    ttsProviderEdgeNote: "Łączy się z serwisem TTS Microsoft. Bezpłatny, bez klucza API.",
    ttsProviderVoicebox: "Voicebox (lokalny)",
    ttsProviderVoiceboxDescription: "Wysokiej jakości lokalny TTS — wymaga uruchomionego Voicebox na urządzeniu",
    ttsProviderElevenLabs: "ElevenLabs",
    ttsProviderElevenLabsDescription: "Premium AI voice — wymaga własnego klucza API",
    voiceboxConfig: "Voicebox (lokalny)",
    voiceboxEndpointLabel: "Adres serwisu",
    voiceboxEndpointPlaceholder: "http://localhost:17493",
    voiceboxEndpointDescription: "Lokalny adres serwisu TTS Voicebox. Wymaga uruchomionego Voicebox na Twoim urządzeniu.",
    voiceboxSave: "Zapisz",
    voiceboxTest: "Testuj połączenie",
    voiceboxTesting: "Testowanie...",
    voiceboxReady: "Połączono",
    voiceboxSetupSuccess: "Voicebox połączony i gotowy",
    voiceboxConnectionError: "Nie można połączyć się z serwisem Voicebox",
  },
