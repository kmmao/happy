...
export const pl: TranslationStructure = {
  ...
  machine: {
    ...
    automationQueuedHint: "Oczekuje na przypisanie do sesji.",
    automationRunningHint: "Trwa wykonywanie lub właśnie jest przypisywane do sesji.",
    automationGuardiansHint: "Zapisane sesje ciągłości dostępne do ponownego użycia lub ponownego podłączenia.",
    ...
    automationLoopsTotalHint: "Wszystkie loopy aktualnie skonfigurowane na tej maszynie.",
    automationLoopsActiveHint: "Loopy, które nadal mogą uruchamiać się automatycznie po wyzwoleniu triggerów lub harmonogramów.",
    automationLoopsBlockedHint: "Loopy zatrzymane przez błędy, politykę lub ręczny bezpieczny stop.",
    automationLoopsPausedHint: "Loopy obecnie wyłączone i czekające na wznowienie.",
    automationLoopsPendingEventsHint: "Loopy z kolejkującymi się zdarzeniami, które nie zostały jeszcze przetworzone.",
    automationLoopsPolicyStoppedHint: "Loopy ostatnio zatrzymane przez politykę lub logikę ochronną.",
    automationOpenLoopsHint: "Otwórz konfigurację loopów, triggery i stan działania tej maszyny.",
    automationTotalAuditEventsHint: "Łączna liczba lokalnych rekordów audytu automatyzacji zapisanych na tej maszynie.",
    automationGuardianReuseCountHint: "Ile razy istniejąca sesja Guardian została użyta ponownie zamiast startu od zera.",
    automationGuardianReuseRateHint: "Odsetek kwalifikujących się uruchomień, w których udało się ponownie użyć sesji Guardian.",
    automationGuardianResetCountHint: "Jak często zapisana ciągłość Guardian musiała zostać wyczyszczona i rozpoczęta od nowa.",
    automationSessionReattachedCountHint: "Ile sesji udało się ponownie podłączyć po przerwaniu lub restarcie.",
    automationWatchdogStopsHint: "Ile razy watchdog wymusił zatrzymanie sesji ze względów bezpieczeństwa.",
