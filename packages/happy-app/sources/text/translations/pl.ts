...
export const pl: TranslationStructure = {
  ...
  projects: {
    ...
    emptySubtitle: "Projekty pojawią się tutaj po podłączeniu CLI",
  ...
  supervisor: {
    ...
    tabSkipped: "Pominięte",
    tabIgnored: "Zignorowane",
  ...
  competitorResearch: {
    ...
    focusAreasPlaceholder: "np. ceny, funkcje, doświadczenie programisty (opcjonalnie)",
