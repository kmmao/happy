...
export const pl: TranslationStructure = {
  ...
  projects: {
    ...
    knowledgeFilterSummary: "Podsumowanie sesji",
    knowledgeFilterRepoMap: "Mapa repozytorium",
    ...
    knowledgeConfigModeAutoHint: "Do 5 wpisów rankingowanych wg trafności słów kluczowych. Najlepszy balans kontekstu i kosztu tokenów",
    knowledgeConfigModeFullHint: "Do 20 wpisów na sesję. Więcej kontekstu, ale wyższe zużycie tokenów",
    knowledgeConfigModeMinimalHint: "Tylko profil projektu (stos technologiczny, konwencje). Bez indywidualnych wpisów",
    knowledgeConfigSensitivity: "Czułość zbierania",
    knowledgeConfigSensitivityConservativeHint: "Ekstrakcja co 5 wartościowych tur lub 60 min. Mniej wpisów, ale wyższa jakość",
    knowledgeConfigSensitivityBalancedHint: "Ekstrakcja co 3 wartościowe tury lub 30 min. Balans pokrycia i szumu",
    knowledgeConfigSensitivityAggressiveHint: "Ekstrakcja po każdej wartościowej turze (maks. 10 min). Najwięcej wpisów, ale więcej szumu",
    knowledgeConfigCollection: "Wyzwalacze zbierania",
    knowledgeConfigTrackFileEdits: "Śledź edycje plików",
    knowledgeConfigTrackFileEditsHint: "Gdy AI tworzy lub modyfikuje pliki → oznacza turę jako wartościową. Wysyłane co 3 tury, nie przy każdym pliku",
    knowledgeConfigTrackTokens: "Śledź głęboką analizę",
    knowledgeConfigTrackTokensHint: "Gdy tura bez edycji plików ma >1500 tokenów wyjścia (głębokie rozumowanie, planowanie) → też oznaczana jako wartościowa",
    knowledgeConfigSummary: "Podsumowanie sesji",
    knowledgeConfigSummaryHint: "Gdy sesja kończy się z ≥2 wartościowymi turami → automatycznie generuje podsumowanie. Dopracowywane przez AI",
    ...
    knowledgeConfigMergeHint: "Wyszukuje wpisy o ≥75% podobieństwie, łączy 2-5 na klaster (maks. 5 klastrów/uruchomienie). Źródłowe stają się «zastąpione». Co 6 godzin",
  ...
  projectConfig: {
    ...
    knowledgeNotAvailable: "Konfiguracja wiedzy niedostępna. Najpierw zsynchronizuj projekt z serwerem.",
