...
export const pl: TranslationStructure = {
  ...
  supervisor: {
    ...
    autoLoopThresholdHint: ({ value }: { value: number }) => `Auto-pętla uruchamia się, gdy healthScore ≥ ${value}. Wyższy = gorsze zdrowie. 24-godzinne ostudzenie pomiędzy auto-startami.`,
