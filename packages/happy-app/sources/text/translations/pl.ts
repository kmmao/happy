...
export const pl: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    requestTimingDiagnostics: "Diagnostyka czasów żądań",
    requestTimingDiagnosticsEnabled:
      "Zapisuj czasy żądań i tur do późniejszej analizy",
    requestTimingDiagnosticsDisabled:
      "Nie zapisuj dodatkowych danych o czasach żądań",
  ...
  sessionInfo: {
    ...
    requestTimingTtft: "Czas do pierwszego tokena",
