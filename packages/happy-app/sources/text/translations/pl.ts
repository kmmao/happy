...
export const pl: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    knowledgeBaseSensitivityConservative: "Ostrożny — mniej, ale wyższej jakości",
    knowledgeBaseSensitivityBalanced: "Zrównoważony — domyślne progi",
    knowledgeBaseSensitivityAggressive: "Agresywny — zbieraj więcej wiedzy",
