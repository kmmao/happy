...
export const pl: TranslationStructure = {
  ...
  projects: {
    ...
    knowledgeConfigModeAutoHint: "Automatycznie decyduje, ile kontekstu wstrzyknąć na podstawie trafności",
    knowledgeConfigModeFullHint: "Zawsze wstrzykuj całą dostępną wiedzę do kontekstu sesji",
    knowledgeConfigModeMinimalHint: "Wstrzykuj tylko krytyczną wiedzę — konwencje i ostrzeżenia",
    knowledgeConfigSensitivity: "Czułość zbierania",
    knowledgeConfigSensitivityConservativeHint: "Zbieraj tylko odkrycia i decyzje o wysokim stopniu pewności",
    knowledgeConfigSensitivityBalancedHint: "Zbieraj większość ustaleń z umiarkowanym filtrowaniem",
    knowledgeConfigSensitivityAggressiveHint: "Zbieraj wszystko — w tym obserwacje o niskim stopniu pewności",
    knowledgeConfigCollection: "Wyzwalacze zbierania",
    knowledgeConfigTrackFileEdits: "Śledź edycje plików",
    knowledgeConfigTrackFileEditsHint: "Zapisuj wiedzę podczas tworzenia lub modyfikacji plików",
    knowledgeConfigTrackToolCalls: "Śledź wywołania narzędzi",
    knowledgeConfigTrackToolCallsHint: "Zapisuj wiedzę z wywołań narzędzi i ich wyników",
    knowledgeConfigTrackTokens: "Śledź wyjście tokenów",
    knowledgeConfigTrackTokensHint: "Zapisuj wiedzę z odpowiedzi asystenta AI",
    knowledgeConfigLifecycle: "Cykl życia",
    knowledgeConfigRefine: "Udoskonalanie AI",
    knowledgeConfigRefineHint: "Użyj AI do ulepszania, deduplikacji i wzbogacania wpisów",
    knowledgeConfigDecay: "Autoarchiwizacja",
    knowledgeConfigDecayHint: "Automatycznie archiwizuj wpisy nieodwiedzane od 30+ dni",
    knowledgeConfigMerge: "Inteligentne scalanie",
    knowledgeConfigMergeHint: "Okresowo wyszukuj i łącz podobne wpisy za pomocą AI",
