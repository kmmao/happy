...
export const pl: TranslationStructure = {
  ...
  agentInput: {
    ...
    context: {
      ...
      autoCompactOn: "AUTO",
      autoCompactOff: "1M",
      autoCompactHintOn: "Podpowiedź /compact przy 75% (200K). Dotknij, aby przełączyć na 1M.",
      autoCompactHintOff: "Kontekst 1M, bez auto-compact. Dotknij, aby kompresować przy 75%.",
    },
    suggestion: {
      fileLabel: "PLIK",
      folderLabel: "FOLDER",
