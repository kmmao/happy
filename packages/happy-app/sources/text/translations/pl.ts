...
export const pl: TranslationStructure = {
  ...
  settingsVoice: {
    ...
    voiceBackendTitle: "Głosowy backend czasu rzeczywistego",
    voiceBackendDescription: "Wybierz silnik realtime voice używany w rozmowach na żywo.",
    livekitServerManagedNote: "Brak skonfigurowanych danych logowania — używane są serwerowe dane LiveKit Cloud. Dodaj własne klucze poniżej, aby włączyć BYOK.",
    livekitConfig: "LiveKit Cloud",
    livekitConfigDescription: "Opcjonalnie: podaj własny LiveKit Cloud API Key, Secret i WSS URL. Zużycie będzie rozliczane na Twoim koncie LiveKit zamiast serwerowym.",
    livekitApiKeyPlaceholder: "API Key (np. APIxxxxxxxx)",
    livekitApiSecretPlaceholder: "API Secret",
    livekitWssUrlPlaceholder: "WSS URL (np. wss://xxx.livekit.cloud)",
    livekitSaveVerify: "Zapisz i zweryfikuj",
    livekitVerifying: "Weryfikacja...",
    livekitVerified: "Zweryfikowano",
    livekitVerifySuccess: "Połączono — dane LiveKit są prawidłowe",
    livekitProject: "Projekt",
    livekitActiveRooms: "Aktywne pokoje",
    livekitMode: "Tryb",
    livekitParticipants: "uczestników",
    livekitViewUsage: "Zobacz użycie w LiveKit Cloud",
    livekitInvalidCredentials: "Nieprawidłowe dane LiveKit",
