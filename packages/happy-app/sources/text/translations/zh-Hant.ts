...
export const zhHant: TranslationStructure = {
  ...
  roadmap: {
    ...
    newMilestone: "新增里程碑",
    milestoneDetail: "里程碑詳情",
    milestoneNotFound: "找不到里程碑",
    newFeature: "新增功能",
    featureDetail: "功能詳情",
    featureNotFound: "找不到功能",
    details: "詳情",
    titlePlaceholder: "標題",
    titleRequired: "標題不能為空",
    descriptionPlaceholder: "描述...",
    targetDate: "目標日期",
    targetDateNone: "無目標日期",
    milestoneLabel: "里程碑",
    moscow: {
      mustHave: "必須有",
      shouldHave: "應該有",
    ...
    complexityLabel: "複雜度",
    features: "功能",
    noFeatures: "此里程碑下尚無功能",
    milestoneOptions: "里程碑選項",
    convertToTask: "轉為任務",
    convertConfirmTitle: "轉為任務",
    convertConfirmMessage: "這將從此功能建立一個新的看板任務。",
    viewTask: "檢視任務",
    deleteMilestoneConfirmTitle: "刪除里程碑",
    deleteMilestoneConfirmMessage:
      "這將同時刪除此里程碑下的所有功能。確定要刪除嗎？",
    deleteFeatureConfirmTitle: "刪除功能",
    deleteFeatureConfirmMessage: "確定要刪除此功能嗎？",
