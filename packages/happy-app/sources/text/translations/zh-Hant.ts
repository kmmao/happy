...
export const zhHant: TranslationStructure = {
  ...
  projects: {
    ...
    knowledgeConfigModeAutoHint: "根據相關性自動決定注入多少上下文",
    knowledgeConfigModeFullHint: "始終將所有可用知識注入工作階段上下文",
    knowledgeConfigModeMinimalHint: "僅注入關鍵知識 — 約定和警告",
    knowledgeConfigSensitivity: "收集靈敏度",
    knowledgeConfigSensitivityConservativeHint: "僅收集高置信度的發現和決策",
    knowledgeConfigSensitivityBalancedHint: "收集大多數發現，進行中等置信度過濾",
    knowledgeConfigSensitivityAggressiveHint: "收集所有內容 — 包括低置信度的觀察",
    knowledgeConfigCollection: "收集觸發器",
    knowledgeConfigTrackFileEdits: "追蹤檔案編輯",
    knowledgeConfigTrackFileEditsHint: "當檔案被建立或修改時記錄知識",
    knowledgeConfigTrackToolCalls: "追蹤工具呼叫",
    knowledgeConfigTrackToolCallsHint: "從工具呼叫及其結果中記錄知識",
    knowledgeConfigTrackTokens: "追蹤 Token 輸出",
    knowledgeConfigTrackTokensHint: "從 AI 助手的回應中記錄知識",
    knowledgeConfigLifecycle: "生命週期",
    knowledgeConfigRefine: "AI 精化",
    knowledgeConfigRefineHint: "使用 AI 改進、去重和豐富新的知識條目",
    knowledgeConfigDecay: "自動歸檔",
    knowledgeConfigDecayHint: "自動歸檔 30 天以上未被存取的過期條目",
    knowledgeConfigMerge: "智慧合併",
    knowledgeConfigMergeHint: "定期使用 AI 尋找並合併相似的知識條目",
