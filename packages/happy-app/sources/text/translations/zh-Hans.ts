...
export const zhHans: TranslationStructure = {
  ...
  ideation: {
    // 创意管理
    emptyTitle: "暂无创意",
    emptySubtitle: "记录灵感，将好创意转为任务",
    newIdea: "新建创意",
    ideaDetail: "创意详情",
    ideaNotFound: "未找到创意",
    details: "详情",
    titlePlaceholder: "创意标题",
    titleRequired: "标题不能为空",
    descriptionPlaceholder: "描述您的创意...",
    categoryLabel: "分类",
    categories: {
      feature: "功能",
      improvement: "改进",
    ...
    priorityLabel: "优先级",
    convertToTask: "转为任务",
    convertConfirmTitle: "转为任务",
    convertConfirmMessage: "这将从此创意创建一个新的看板任务。",
    dismiss: "忽略",
    dismissConfirmTitle: "忽略创意",
    dismissConfirmMessage: "确定要忽略这个创意吗？",
    deleteConfirmTitle: "删除创意",
    deleteConfirmMessage: "确定要删除这个创意吗？",
    converted: "已转为任务",
    viewTask: "查看任务",
    actions: {
      changeStatus: "更改状态",
    ...
    stats: {
      totalIdeas: ({ count }: { count: number }) => `${count} 个创意`,
      activeIdeas: ({ count }: { count: number }) => `${count} 个活跃`,
    },
    filter: {
      all: "全部",
    },
  ...
  roadmap: {
    emptyTitle: "暂无里程碑",
    emptySubtitle: "创建里程碑来规划您的项目路线图",
    newMilestone: "新建里程碑",
    milestoneDetail: "里程碑详情",
    milestoneNotFound: "未找到里程碑",
    newFeature: "新建功能",
    featureDetail: "功能详情",
    featureNotFound: "未找到功能",
    details: "详情",
    titlePlaceholder: "标题",
    titleRequired: "标题不能为空",
    descriptionPlaceholder: "描述...",
    targetDate: "目标日期",
    targetDateNone: "无目标日期",
    milestoneLabel: "里程碑",
    moscow: {
      mustHave: "必须有",
      shouldHave: "应该有",
    ...
    complexityLabel: "复杂度",
    features: "功能",
    noFeatures: "此里程碑下暂无功能",
    milestoneOptions: "里程碑选项",
    convertToTask: "转为任务",
    convertConfirmTitle: "转为任务",
    convertConfirmMessage: "这将从此功能创建一个新的看板任务。",
    viewTask: "查看任务",
    deleteMilestoneConfirmTitle: "删除里程碑",
    deleteMilestoneConfirmMessage:
      "这将同时删除此里程碑下的所有功能。确定要删除吗？",
    deleteFeatureConfirmTitle: "删除功能",
    deleteFeatureConfirmMessage: "确定要删除此功能吗？",
