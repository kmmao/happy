...
export const zhHans: TranslationStructure = {
  ...
  projects: {
    ...
    knowledgeConfigModeAutoHint: "根据相关性自动决定注入多少上下文",
    knowledgeConfigModeFullHint: "始终将所有可用知识注入会话上下文",
    knowledgeConfigModeMinimalHint: "仅注入关键知识 — 约定和警告",
    knowledgeConfigSensitivity: "收集灵敏度",
    knowledgeConfigSensitivityConservativeHint: "仅收集高置信度的发现和决策",
    knowledgeConfigSensitivityBalancedHint: "收集大多数发现，进行中等置信度过滤",
    knowledgeConfigSensitivityAggressiveHint: "收集所有内容 — 包括低置信度的观察",
    knowledgeConfigCollection: "收集触发器",
    knowledgeConfigTrackFileEdits: "追踪文件编辑",
    knowledgeConfigTrackFileEditsHint: "当文件被创建或修改时记录知识",
    knowledgeConfigTrackToolCalls: "追踪工具调用",
    knowledgeConfigTrackToolCallsHint: "从工具调用及其结果中记录知识",
    knowledgeConfigTrackTokens: "追踪 Token 输出",
    knowledgeConfigTrackTokensHint: "从 AI 助手的响应中记录知识",
    knowledgeConfigLifecycle: "生命周期",
    knowledgeConfigRefine: "AI 精化",
    knowledgeConfigRefineHint: "使用 AI 改进、去重和丰富新的知识条目",
    knowledgeConfigDecay: "自动归档",
    knowledgeConfigDecayHint: "自动归档 30 天以上未被访问的过期条目",
    knowledgeConfigMerge: "智能合并",
    knowledgeConfigMergeHint: "定期使用 AI 查找并合并相似的知识条目",
