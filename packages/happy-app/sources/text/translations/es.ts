...
export const es: TranslationStructure = {
  ...
  machine: {
    ...
    automationQueuedHint: "Esperando a ser enviada a una sesión.",
    automationRunningHint: "Se está ejecutando ahora mismo o está siendo enviada en este momento.",
    automationGuardiansHint: "Sesiones de continuidad guardadas disponibles para reutilizar o volver a adjuntar.",
    ...
    automationLoopsTotalHint: "Todos los loops configurados actualmente en esta máquina.",
    automationLoopsActiveHint: "Loops que todavía pueden ejecutarse automáticamente cuando se disparan triggers o programaciones.",
    automationLoopsBlockedHint: "Loops detenidos por fallos, política o una parada manual de seguridad.",
    automationLoopsPausedHint: "Loops deshabilitados actualmente y a la espera de reanudarse.",
    automationLoopsPendingEventsHint: "Loops con eventos en cola que aún no se han procesado.",
    automationLoopsPolicyStoppedHint: "Loops detenidos recientemente por la política o la lógica de protección.",
    automationOpenLoopsHint: "Abre la configuración, los triggers y el estado de ejecución de los loops de esta máquina.",
    automationTotalAuditEventsHint: "Número total de registros locales de auditoría de automatización almacenados en esta máquina.",
    automationGuardianReuseCountHint: "Cuántas veces se reutilizó una sesión Guardian existente en lugar de empezar desde cero.",
    automationGuardianReuseRateHint: "Porcentaje de ejecuciones elegibles que reutilizaron correctamente una sesión Guardian.",
    automationGuardianResetCountHint: "Con qué frecuencia fue necesario borrar y reiniciar la continuidad guardada de Guardian.",
    automationSessionReattachedCountHint: "Cuántas sesiones se volvieron a adjuntar correctamente después de una interrupción o reinicio.",
    automationWatchdogStopsHint: "Cuántas veces el watchdog detuvo una sesión a la fuerza por seguridad.",
