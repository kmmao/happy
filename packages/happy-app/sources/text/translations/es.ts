...
export const es: TranslationStructure = {
  ...
  supervisor: {
    ...
    autoLoopThresholdHint: ({ value }: { value: number }) => `Auto-loop se dispara cuando healthScore ≥ ${value}. Más alto = menos saludable. 24h de enfriamiento entre auto-arranques.`,
