...
export const es: TranslationStructure = {
  ...
  settingsVoice: {
    ...
    voiceBackendTitle: "Backend de voz en tiempo real",
    voiceBackendDescription: "Elige el motor de voz en tiempo real usado para conversaciones en directo.",
    livekitServerManagedNote: "Sin credenciales configuradas — usando credenciales LiveKit Cloud gestionadas por el servidor. Añade tus propias claves a continuación para BYOK.",
    livekitConfig: "LiveKit Cloud",
    livekitConfigDescription: "Opcional: proporciona tu propio LiveKit Cloud API Key, Secret y WSS URL. El uso se facturará a tu cuenta de LiveKit en lugar de la del servidor.",
    livekitApiKeyPlaceholder: "API Key (ej. APIxxxxxxxx)",
    livekitApiSecretPlaceholder: "API Secret",
    livekitWssUrlPlaceholder: "WSS URL (ej. wss://xxx.livekit.cloud)",
    livekitSaveVerify: "Guardar y verificar",
    livekitVerifying: "Verificando...",
    livekitVerified: "Verificado",
    livekitVerifySuccess: "Conectado — credenciales de LiveKit válidas",
