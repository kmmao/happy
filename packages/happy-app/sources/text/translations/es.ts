...
export const es: TranslationStructure = {
  ...
  settingsVoice: {
    ...
    livekitConfigDescription: "Opcional: proporciona tu propio LiveKit Cloud API Key y Secret. El uso se facturará a tu cuenta de LiveKit en lugar de la del servidor.",
    ...
    ttsProviderDescription: "Elige cómo se convierte el texto en voz. Las opciones gratuitas no requieren configuración.",
    ttsProviderWebSpeech: "Web Speech API",
    ttsProviderWebSpeechDescription: "TTS nativo del navegador sin coste — no se requiere cuenta",
    ttsProviderWebSpeechNote: "Usa el motor de texto a voz integrado en el dispositivo. Funciona instantáneamente sin configuración.",
    ttsProviderEdge: "Microsoft Edge TTS",
    ttsProviderEdgeDescription: "TTS en la nube gratuito y de alta calidad de Microsoft",
    ttsProviderEdgeNote: "Se conecta al servicio TTS de Microsoft. Gratis, no se requiere clave API.",
    ttsProviderVoicebox: "Voicebox (local)",
    ttsProviderVoiceboxDescription: "TTS local de alta calidad — requiere Voicebox ejecutándose en tu dispositivo",
    ttsProviderElevenLabs: "ElevenLabs",
    ttsProviderElevenLabsDescription: "Voz IA premium — requiere tu propia clave API",
    voiceboxConfig: "Voicebox (local)",
    voiceboxEndpointLabel: "URL del servicio",
    voiceboxEndpointPlaceholder: "http://localhost:17493",
    voiceboxEndpointDescription: "URL del servicio TTS local de Voicebox. Requiere que Voicebox esté ejecutándose en tu dispositivo.",
    voiceboxSave: "Guardar",
    voiceboxTest: "Probar conexión",
    voiceboxTesting: "Probando...",
    voiceboxReady: "Conectado",
    voiceboxSetupSuccess: "Voicebox conectado y listo",
    voiceboxConnectionError: "No se pudo conectar al servicio Voicebox",
  },
