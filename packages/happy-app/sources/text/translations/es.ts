...
export const es: TranslationStructure = {
  ...
  projects: {
    ...
    knowledgeConfigModeAutoHint: "Decide automáticamente cuánto contexto inyectar según la puntuación de relevancia",
    knowledgeConfigModeFullHint: "Inyecta todas las entradas activas en cada sesión — puede aumentar el consumo de tokens",
    knowledgeConfigModeMinimalHint: "Solo convenciones y advertencias — ignora descubrimientos, decisiones y correcciones",
    knowledgeConfigSensitivity: "Sensibilidad de recopilación",
    knowledgeConfigSensitivityConservativeHint: "Solo entradas de alta confianza. Las observaciones de baja confianza se descartan",
    knowledgeConfigSensitivityBalancedHint: "La mayoría de hallazgos. Las entradas de baja confianza se mantienen pero decaen más rápido (peso ×1.0 vs ×0.3)",
    knowledgeConfigSensitivityAggressiveHint: "Recopila todo incluyendo observaciones especulativas. Más ruido pero nada se pierde",
    knowledgeConfigCollection: "Activadores de recopilación",
    knowledgeConfigTrackFileEdits: "Rastrear ediciones de archivos",
    knowledgeConfigTrackFileEditsHint: "Registra descubrimientos cuando la IA crea o modifica archivos durante una sesión",
    knowledgeConfigTrackToolCalls: "Rastrear llamadas a herramientas",
    knowledgeConfigTrackToolCallsHint: "Registra conocimiento de llamadas a herramientas (bash, read, edit, grep, etc.) y sus resultados",
    knowledgeConfigTrackTokens: "Rastrear salida de tokens",
    knowledgeConfigTrackTokensHint: "Extrae conocimiento del texto del asistente de IA (razonamiento, explicaciones)",
    ...
    knowledgeConfigMergeHint: "Busca entradas con ≥75% similitud, fusiona 2-5 por clúster (máx. 3 clústeres/ejecución). Las fuentes pasan a 'reemplazadas'. Cada 6 horas",
