...
export const es: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    worldModelEnabled: "Pestañas del modelo del mundo visibles en proyectos",
    worldModelDisabled: "Pestañas del modelo del mundo ocultas",
    ...
    knowledgeBaseMode: "Modo de base de conocimiento",
    knowledgeBaseModeAuto: "Auto — inyectar contexto según sea necesario",
    knowledgeBaseModeFull: "Completo — siempre inyectar todo el contexto",
    knowledgeBaseModeMinimal: "Mínimo — inyectar solo lo esencial",
    knowledgeBaseSensitivity: "Sensibilidad de recolección",
    knowledgeBaseSensitivityConservative: "Conservador — 5 turnos / 60 min, herramientas > 8, tokens > 800",
    knowledgeBaseSensitivityBalanced: "Equilibrado — 3 turnos / 30 min, herramientas > 5, tokens > 500",
    knowledgeBaseSensitivityAggressive: "Agresivo — 1 turno / 10 min, herramientas > 3, tokens > 200",
    knowledgeBaseTrackFileEdits: "Rastrear ediciones de archivos",
    knowledgeBaseTrackFileEditsSubtitle: "Recopilar conocimiento al crear o editar archivos",
    knowledgeBaseTrackToolCalls: "Rastrear llamadas a herramientas",
    knowledgeBaseTrackToolCallsSubtitle: "Recopilar conocimiento con muchas invocaciones",
    knowledgeBaseTrackTokens: "Rastrear salida de tokens",
    knowledgeBaseTrackTokensSubtitle: "Recopilar conocimiento de respuestas largas de IA",
    knowledgeBaseFooter: "Los cambios se aplican en nuevas sesiones. Las sesiones en curso no se ven afectadas.",
    knowledgeBaseAllTracksOff: "Todos los activadores de recolección están desactivados. No se recopilará conocimiento hasta que se active al menos uno.",
  ...
  session: {
    ...
    rewindSessionNotActive: "Retroceder requiere una sesión activa. Inicia una nueva sesión para usar esta función.",
    ...
    progressTodoPromptVerify: ({ content }: { content: string }) =>
      `Por favor verifica si la tarea "${content}" realmente está completa. Lista las evidencias (archivos, pruebas, comandos). Si falta algo, llama a mcp__happy__update_progress para volver a marcarla como in_progress o pending.`,
    progressTodoPromptContinue: ({ content }: { content: string }) =>
      `Por favor trabaja ahora en "${content}" (continúa desde donde lo dejaste). Cuando haya progreso, llama a mcp__happy__update_progress para actualizar su estado.`,
    progressTodoPromptIssue: ({ content }: { content: string }) =>
      `La tarea "${content}" está marcada como completa, pero creo que no lo está. Razón: [añade la tuya]. Revísalo; si estás de acuerdo, llama a mcp__happy__update_progress para volver a in_progress o pending.`,
  ...
  agentInput: {
    ...
    effort: {
      ...
      xhigh: "XHigh",
      xhighDesc: "Recomendado para tareas sensibles a la inteligencia (Opus 4.7)",
      max: "Máximo",
  ...
  machine: {
    ...
    automationGuardianReuseCountHint: "Reutilizadas en vez de crear nuevas",
    automationGuardianReuseRateHint: "Tasa de reutilización exitosa",
    automationGuardianResetCountHint: "Borradas y reiniciadas",
    ...
    automationGuardianUsageHint: "Muestra con qué frecuencia se reutilizó, recordó o reinició cada clave Guardian.",
    automationClearAuditHint: "Elimina los registros locales de auditoría manteniendo intactos los trabajos actuales y el estado de Guardian.",
    automationAuditHint: "Eventos recientes a nivel de máquina sobre decisiones de automatización, continuidad de Guardian y anomalías.",
    automationTimelineHint: "Vista cronológica de los hitos recientes del ciclo de vida de los trabajos.",
    automationAlertsHint: "Muestra primero los problemas que probablemente requieran atención manual, como anomalías o Guardians que deberían recuperarse.",
    ...
    automationOverviewHint: "Usa esta página para entender los trabajos actuales, la continuidad de Guardian, la salud de los loops y las señales de auditoría antes de entrar en detalles.",
    ...
    automationSearchHint: "Busca por nombre del trabajo, clave Guardian, ID de sesión, ID de loop, ID de proyecto o texto de error.",
    automationJobFiltersHint: "Enfoca la lista de trabajos por etapa de ejecución: en marcha, fallidos, finalizados o recuperados.",
    automationAuditFiltersHint: "Limita los eventos de auditoría a anomalías, continuidad de Guardian, ciclo de vida del trabajo o eventos de recuperación.",
    automationGuardianFiltersHint: "Distingue los Guardians actualmente adjuntos, persistidos para reutilizar más tarde o recuperados tras reconectarse.",
    ...
    automationSectionGuardians: "Estado de continuidad de sesiones",
    automationSectionAuditStats: "Métricas de salud de auditoría",
    automationSectionGuardianUsage: "Historial de reutilización por guardian",
    ...
    agentLoopBootstrapHint: "Escanea repositorios de esta máquina, genera planes de loop y materialízalos en lote.",
    agentLoopBootstrapEmpty: "Aún no hay repositorios listos para bootstrap — escanea esta máquina para descubrir candidatos",
  ...
  world: {
    ...
    deleteLawConfirmBody: "¿Estás seguro de que quieres eliminar esta ley?",
    dashboardTitle: "Resumen del mundo",
    autonomyScore: "Autonomía",
    autonomyScoreDesc: "Decisiones auto-resueltas en los últimos 30 días",
    activeGroups: "Grupos activos",
    pendingDecisions: "Decisiones pendientes",
    goalsOverview: "Objetivos",
    goalsActive: "Activos",
    goalsCompleted: "Completados",
    goalsBlocked: "Bloqueados",
    recentDecisions: "Decisiones recientes",
    agentMessages: "Mensajes de Agent",
    noDataYet: "Aún no hay datos del mundo",
    noDataHint: "Configura narrativa, leyes y roles para habilitar el World Model",
    lawCount: "Leyes",
    lawSuggestions: "Sugerencias de leyes",
    ...
    generateSuccess: "Elementos del mundo generados — revisa y guarda",
    generateError: "Error al generar los elementos del mundo",
    generateConfirmTitle: "¿Sobrescribir contenido existente?",
    generateConfirmBody: "Esto reemplazará la narrativa y las leyes actuales con contenido autogenerado. Puedes revisar antes de guardar.",
    generateSkipped: "Omitido (ya existe)",
    generatePartialError: "Fallos parciales",
    modeAuto: "Inicio inteligente",
    modeCustom: "Personalizado",
    modeAutoHint: "Solo completa automáticamente las partes faltantes — la narrativa, leyes, roles y objetivos existentes se conservarán.",
    modeCustomHint: "Describe este mundo o pega contexto, y generaremos todos los elementos del mundo basados en tu descripción.",
    customPromptPlaceholder: "Describe la visión de este mundo, stack tecnológico, estructura del equipo, o pega un README...",
    ...
    generateCustomAction: "Generar desde descripción",
    goalHealth: "Salud del objetivo",
    avgHealthScore: "Puntuación promedio",
    worldAlias: "Nombre del mundo",
    worldAliasDescription: "Nombre personalizado para este mundo",
    worldAliasNotSet: "No establecido",
    worldAliasPromptTitle: "Nombre del mundo",
    worldAliasPromptMessage: "Introduce un nombre personalizado para este mundo",
    worldTerminate: "Terminar mundo",
    worldTerminateConfirm: "¿Estás seguro de que quieres terminar este mundo? Se ocultará de la lista.",
    worldRevive: "Revivir mundo",
    worldReviveConfirm: "¿Estás seguro de que quieres revivir este mundo?",
  },
  suggestions: {
    suggestedNextSteps: "Próximos pasos sugeridos",
    noSuggestions: "Sin sugerencias por ahora",
    noSuggestionsHint: "Las sugerencias aparecerán cuando los objetivos estén bloqueados o las tareas fallen",
    refresh: "Actualizar",
    refreshing: "Actualizando...",
    accept: "Aceptar",
    dismiss: "Descartar",
    acceptConfirmTitle: "Aceptar sugerencia",
  ...
  governance: {
    title: "Gobernanza",
    policyMode: "Modo de autonomía",
    policyModeDesc: "Controla cómo actúa el mundo de forma autónoma",
    modeDisabledDesc: "Sin acciones automáticas",
    modeSuggestDesc: "Solo sugerencias, tú decides",
    modeSemiAutoDesc: "Auto-aceptar tareas seguras",
    modeAutoDesc: "Auto-aceptar tareas y objetivos",
    autoAcceptTypes: "Tipos de auto-aceptación",
    typeTask: "Tareas",
    typeGoal: "Objetivos",
    typeDecision: "Decisiones (con precedente)",
    auditLog: "Auditoría de automatización",
    auditEmpty: "Aún no hay acciones auto-aceptadas",
    auditVeto: "Vetar",
    auditVetoConfirmTitle: "Vetar acción automática",
    auditVetoConfirmBody: "Esto cancelará la acción ejecutada automáticamente. ¿Estás seguro?",
    auditVetoed: "Acción vetada",
    auditVetoFailed: "No se pudo vetar",
    auditWindowExpired: "Ventana de veto expirada",
    auditAutoResolved: "Auto-resuelto",
    auditAutoAccepted: "Auto-aceptado",
  },
  collaboration: {
    title: "Colaboración de grupos",
    noBlocks: "Sin bloqueos activos",
    blockedChains: "Cadenas bloqueadas",
    openConflicts: "Conflictos abiertos",
    pendingDecisions: "Decisiones pendientes",
    groupActivity: "Actividad de grupos",
    waitingFor: ({ role }: { role: string }) => `Esperando a ${role}`,
    handoffs: "Transferencias",
    reviewRequests: "Revisiones",
    dependencyBlocked: "Bloqueado",
    chainLabel: ({ chain }: { chain: string }) => `Cadena: ${chain}`,
  ...
  roles: {
    ...
    dutiesCount: ({ count }: { count: number }) => `${count} ${count === 1 ? "deber" : "deberes"}`,
    skillsCount: ({ count }: { count: number }) => `${count} ${count === 1 ? "habilidad" : "habilidades"}`,
    ...
    deleteHasMembersBody: ({ count }: { count: number }) => `Este rol está asignado a ${count} ${count === 1 ? "miembro" : "miembros"}. Al eliminarlo se quitará el vínculo. ¿Continuar?`,
  },
  members: {
    title: "Miembros",
    ...
    emptyState: "Aún no hay miembros del equipo. Añade miembros para habilitar la toma de decisiones colaborativa.",
    usernameLabel: "Nombre de usuario",
    usernamePlaceholder: "Introduce el nombre de usuario para invitar",
    roleLabel: "Nivel de permiso",
    roleOwner: "Propietario",
    roleAdmin: "Administrador",
    roleMember: "Miembro",
    roleObserver: "Observador",
    expertiseLabel: "Especialidad",
    expertisePlaceholder: "Añadir etiqueta de especialidad...",
    lawAuthorityLabel: "Autoridad de leyes",
    lawCreate: "Crear",
    lawSuggest: "Solo sugerir",
    lawReadonly: "Solo lectura",
    decisionScopeLabel: "Alcance de decisiones",
    decisionAll: "Todas las decisiones",
    decisionAssigned: "Solo asignadas",
    decisionNone: "Ninguna",
    goalAuthorityLabel: "Autoridad de objetivos",
    goalCreate: "Crear",
    goalSuggest: "Solo sugerir",
    goalReadonly: "Solo lectura",
    notifyLevelLabel: "Notificaciones",
    notifyAll: "Todas",
    notifyCritical: "Solo críticas",
    notifyAssigned: "Solo asignadas",
    notifyNone: "Ninguna",
    availabilityLabel: "Disponibilidad",
    availabilityActive: "Activo",
    availabilityAway: "Ausente",
    availabilityDelegate: "Delegar",
    delegateToLabel: "Delegar a",
    saved: "Miembro guardado",
    saveError: "Error al guardar miembro",
    removed: "Miembro eliminado",
    removeConfirmTitle: "Eliminar miembro",
    removeConfirmBody: "¿Estás seguro de que quieres eliminar a este miembro? Perderá acceso al modelo del mundo del proyecto.",
    cannotRemoveOwner: "No se puede eliminar al propietario del proyecto",
    memberAlreadyExists: "Este usuario ya es miembro",
    userNotFound: "Usuario no encontrado",
    ...
    assignedRolesSection: "Roles de agente asignados",
    assignedRolesHint: "Selecciona qué roles de agente puede realizar este miembro",
  },
  goals: {
    title: "Objetivos",
    createGoal: "Nuevo objetivo",
    goalTitle: "Título",
    goalTitlePlaceholder: "¿Qué quieres lograr?",
    goalDescription: "Descripción",
    goalDescriptionPlaceholder: "Proporciona más detalles sobre este objetivo...",
    ...
    emptyGoalsHint: "Crea un objetivo y el sistema lo descompondrá automáticamente en tareas",
    autoDecompose: "Descomponer automáticamente en tareas",
    tasks: ({ count }: { count: number }) => `${count} ${count === 1 ? "tarea" : "tareas"}`,
    subGoals: ({ count }: { count: number }) => `${count} ${count === 1 ? "subobjetivo" : "subobjetivos"}`,
    cancelGoal: "Cancelar objetivo",
    cancelGoalConfirm: "Esto cancelará todas las tareas activas. ¿Continuar?",
    plannerWorking: "El planificador está descomponiendo...",
    ...
    decomposeTriggered: "Descomposición iniciada",
    decomposeError: "Error al iniciar descomposición",
    viewSession: "Ver sesión",
    taskIndex: ({ index }: { index: number }) => `Tarea #${index}`,
    ...
    deleteGoalConfirm: "¿Eliminar este objetivo permanentemente?",
    deleted: "Objetivo eliminado",
    healthScore: "Salud",
    healthCritical: "Crítico",
    healthWarning: "No saludable",
    healthHealthy: "Saludable",
    layerStrategic: "Estratégico",
    layerOperational: "Operativo",
    layerExecution: "Ejecución",
    replan: "Replanificar",
    replanConfirm: "¿Cancelar tareas activas y re-descomponer este objetivo?",
  ...
  decision: {
    ...
    adjudicateError: "Error al adjudicar la decisión",
    assignedTo: "Asignado",
    opinions: "Opiniones",
    submitOpinion: "Enviar opinión",
    opinionSubmitted: "Opinión enviada",
    opinionConflict: "Opiniones en conflicto — escalado al administrador",
