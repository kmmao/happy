...
export const es: TranslationStructure = {
  ...
  newSession: {
    ...
    gitRepos: {
      ...
      showingCount: ({ showing, total }: { showing: number; total: number }) =>
        `Mostrando ${showing} de ${total} repositorios`,
    },
  },
  ...
  session: {
    ...
    rewindTitle: "Revertir archivos",
    rewindConfirm: "¿Revertir los archivos al estado de este mensaje?",
    rewindAction: "Revertir",
    rewindFiles: "archivos afectados",
    rewindSuccess: "Archivos revertidos exitosamente",
    rewindFailed: "Error al revertir",
    rewindUnavailable: "Los puntos de control de archivos no están disponibles para esta sesión",
    rewindUnknownError: "Ocurrió un error desconocido",
  ...
  projects: {
    ...
    configDefaultModel: "Modelo predeterminado",
    configDefaultModelDescription: "Modelo usado para nuevas sesiones en este proyecto",
    configDefaultModelNotSet: "Predeterminado",
