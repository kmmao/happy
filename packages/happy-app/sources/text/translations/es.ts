...
export const es: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    knowledgeBaseSensitivityConservative: "Conservador — menos pero de mayor calidad",
    knowledgeBaseSensitivityBalanced: "Equilibrado — umbrales predeterminados",
    knowledgeBaseSensitivityAggressive: "Agresivo — capturar más conocimiento",
