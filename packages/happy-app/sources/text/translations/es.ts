...
export const es: TranslationStructure = {
  ...
  gitHosts: {
    ...
    webhookGuideTitle: "Configuración de Webhook de {{provider}}",
    ...
    webhookTestFail: "El servidor devolvió HTTP {{status}}",
    ...
    remoteWebhookFail: "Error al crear webhook remoto: {{error}}",
