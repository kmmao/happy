...
export const es: TranslationStructure = {
  ...
  projects: {
    ...
    knowledgeConfigModeAutoHint: "Decide automáticamente cuánto contexto inyectar según la relevancia",
    knowledgeConfigModeFullHint: "Siempre inyecta todo el conocimiento disponible en el contexto de la sesión",
    knowledgeConfigModeMinimalHint: "Solo inyecta conocimiento crítico — convenciones y advertencias",
    knowledgeConfigSensitivity: "Sensibilidad de recopilación",
    knowledgeConfigSensitivityConservativeHint: "Solo recopila descubrimientos y decisiones de alta confianza",
    knowledgeConfigSensitivityBalancedHint: "Recopila la mayoría de hallazgos con filtrado de confianza moderado",
    knowledgeConfigSensitivityAggressiveHint: "Recopila todo — incluyendo observaciones de baja confianza",
    knowledgeConfigCollection: "Activadores de recopilación",
    knowledgeConfigTrackFileEdits: "Rastrear ediciones de archivos",
    knowledgeConfigTrackFileEditsHint: "Registra conocimiento cuando se crean o modifican archivos",
    knowledgeConfigTrackToolCalls: "Rastrear llamadas a herramientas",
    knowledgeConfigTrackToolCallsHint: "Registra conocimiento de las invocaciones de herramientas y sus resultados",
    knowledgeConfigTrackTokens: "Rastrear salida de tokens",
    knowledgeConfigTrackTokensHint: "Registra conocimiento de las respuestas del asistente de IA",
    knowledgeConfigLifecycle: "Ciclo de vida",
    knowledgeConfigRefine: "Refinamiento por IA",
    knowledgeConfigRefineHint: "Usa IA para mejorar, deduplicar y enriquecer nuevas entradas",
    knowledgeConfigDecay: "Archivo automático",
    knowledgeConfigDecayHint: "Archiva automáticamente entradas no accedidas en más de 30 días",
    knowledgeConfigMerge: "Fusión inteligente",
    knowledgeConfigMergeHint: "Busca y fusiona periódicamente entradas similares usando IA",
