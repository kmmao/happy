...
export const es: TranslationStructure = {
  ...
  workflows: {
    ...
    sectionModel: "Modelo",
    sectionEffort: "Esfuerzo de razonamiento",
    effortDefault: "Predeterminado",
    modelFollowsSettings: "Sigue el valor predeterminado de Ajustes",
    loopEditModalTitle: "Editar bucle",
    detailEdit: "Editar",
    ...
    actionRunNow: "Ejecutar ahora",
    actionRunNowSuccessTitle: "Bucle activado",
    actionRunNowSuccessMessage: "Se está iniciando una nueva iteración; revisa las sesiones de abajo en un momento.",
    actionRunNowErrorTitle: "No se pudo ejecutar el bucle",
    ...
    loopBootstrapSlashCommandPresetsLabel: "Skills comunes",
    loopBootstrapSlashCommandPresetNone: "Ninguno",
    ...
    loopIssueHintToggleShow: "💡 Sobre guardar resultados en Git",
    loopIssueHintToggleHide: "Ocultar consejo",
    webhookIssueHint: "Have the Agent run `happy issue comment <n> --body \"…\"` or `issue close <n>` before exiting — token is already in env.",
    webhookIssueHintToggleShow: "💡 Sobre comentar en el Issue",
    webhookIssueHintToggleHide: "Ocultar consejo",
  },
  ...
  session: {
    ...
    chooseDesign: "Boceto de diseño (HTML)",
  ...
  skills: {
    routing: "Enrutamiento de front-matter",
    userOnlyBadge: "solo usuario",
    title: "Skills",
    newSkill: "New Skill",
  ...
  dynamicWorkflows: {
    synthesis: "Síntesis",
    synthesisHint: "Un agente final resume todos los resultados de los subagentes.",
    stop: "Detener",
    rerun: "Re-ejecutar",
    merge: "Fusionar",
    discard: "Descartar",
    ...
    isolationHint: "Cada agente trabaja en su propia rama; ediciones paralelas seguras, revisa cada una.",
  ...
  plan: {
    ...
    approveFreshContext: "Limpiar contexto y ejecutar",
