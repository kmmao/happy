...
export const it: TranslationStructure = {
  ...
  projects: {
    ...
    knowledgeConfigModeAutoHint: "Decide automaticamente quanto contesto iniettare in base alla rilevanza",
    knowledgeConfigModeFullHint: "Inietta sempre tutta la conoscenza disponibile nel contesto della sessione",
    knowledgeConfigModeMinimalHint: "Inietta solo la conoscenza critica — convenzioni e avvertimenti",
    knowledgeConfigSensitivity: "Sensibilità di raccolta",
    knowledgeConfigSensitivityConservativeHint: "Raccoglie solo scoperte e decisioni ad alta affidabilità",
    knowledgeConfigSensitivityBalancedHint: "Raccoglie la maggior parte dei risultati con filtraggio moderato",
    knowledgeConfigSensitivityAggressiveHint: "Raccoglie tutto — incluse osservazioni a bassa affidabilità",
    knowledgeConfigCollection: "Trigger di raccolta",
    knowledgeConfigTrackFileEdits: "Traccia modifiche file",
    knowledgeConfigTrackFileEditsHint: "Registra conoscenza quando i file vengono creati o modificati",
    knowledgeConfigTrackToolCalls: "Traccia chiamate strumenti",
    knowledgeConfigTrackToolCallsHint: "Registra conoscenza dalle invocazioni degli strumenti e dai loro risultati",
    knowledgeConfigTrackTokens: "Traccia output token",
    knowledgeConfigTrackTokensHint: "Registra conoscenza dalle risposte dell'assistente IA",
    knowledgeConfigLifecycle: "Ciclo di vita",
    knowledgeConfigRefine: "Raffinamento IA",
    knowledgeConfigRefineHint: "Usa l'IA per migliorare, deduplicare e arricchire nuove voci",
    knowledgeConfigDecay: "Archiviazione automatica",
    knowledgeConfigDecayHint: "Archivia automaticamente le voci non accedute da 30+ giorni",
    knowledgeConfigMerge: "Unione intelligente",
    knowledgeConfigMergeHint: "Cerca e unisci periodicamente voci simili usando l'IA",
