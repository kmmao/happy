...
export const it: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    knowledgeBaseSensitivityConservative: "Conservativa — meno voci ma di qualità superiore",
    knowledgeBaseSensitivityBalanced: "Bilanciata — soglie predefinite",
    knowledgeBaseSensitivityAggressive: "Aggressiva — cattura più conoscenza",
