...
export const en: TranslationStructure = {
  ...
  errors: {
    ...
    voiceRealtimeFallback: "Realtime gateway unavailable — switched to ElevenLabs for this conversation",
  ...
  settingsVoice: {
    ...
    providerDescription: "Choose which backend powers voice conversations.",
    providerElevenLabs: "ElevenLabs",
    providerElevenLabsSubtitle: "Managed agent, available on all platforms",
    providerRealtime: "Realtime Gateway",
    providerRealtimeSubtitle: "OpenAI Realtime compatible endpoint",
    realtimeGatewayConfig: "Realtime Gateway",
    realtimeGatewayDescription: "Base URL of an OpenAI Realtime compatible gateway, such as a sub2api instance. The API key is sent as a Bearer token.",
    realtimeGatewayUrl: "Base URL",
    realtimeGatewayUrlPlaceholder: "https://gateway.example.com",
    realtimeGatewayApiKey: "API Key",
    realtimeGatewayApiKeyPlaceholder: "sk-...",
    realtimeVoice: "Voice",
    realtimeVoicePlaceholder: "Leave empty for the gateway default",
  },
