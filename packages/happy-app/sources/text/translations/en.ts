...
export const en: TranslationStructure = {
  ...
  projects: {
    ...
    knowledgeConfigModeAutoHint: "Automatically decides how much context to inject based on relevance",
    knowledgeConfigModeFullHint: "Always inject all available knowledge into the session context",
    knowledgeConfigModeMinimalHint: "Only inject critical knowledge — conventions and warnings",
    knowledgeConfigSensitivity: "Collection Sensitivity",
    knowledgeConfigSensitivityConservativeHint: "Only collect high-confidence discoveries and decisions",
    knowledgeConfigSensitivityBalancedHint: "Collect most findings with moderate confidence filtering",
    knowledgeConfigSensitivityAggressiveHint: "Collect everything — including low-confidence observations",
    knowledgeConfigCollection: "Collection Triggers",
    knowledgeConfigTrackFileEdits: "Track File Edits",
    knowledgeConfigTrackFileEditsHint: "Record knowledge when files are created or modified",
    knowledgeConfigTrackToolCalls: "Track Tool Calls",
    knowledgeConfigTrackToolCallsHint: "Record knowledge from tool invocations and their results",
    knowledgeConfigTrackTokens: "Track Token Output",
    knowledgeConfigTrackTokensHint: "Record knowledge from AI assistant responses",
    knowledgeConfigLifecycle: "Lifecycle",
    knowledgeConfigRefine: "AI Refinement",
    knowledgeConfigRefineHint: "Use AI to improve, deduplicate, and enrich new knowledge entries",
    knowledgeConfigDecay: "Auto Archive",
    knowledgeConfigDecayHint: "Automatically archive stale entries that haven't been accessed in 30+ days",
    knowledgeConfigMerge: "Smart Merge",
    knowledgeConfigMergeHint: "Periodically find and merge similar knowledge entries using AI",
