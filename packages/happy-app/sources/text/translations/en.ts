...
export const en: TranslationStructure = {
  ...
  settings: {
    ...
    appLock: "App Lock",
    appLockSubtitle: "Require a PIN or biometrics to open the app",
  ...
  settingsFeatures: {
    ...
    autoApprovePlanInYolo: "Auto-approve plans in Yolo",
    autoApprovePlanInYoloDescription:
      "In Yolo/bypass mode, approve plans automatically and continue with full context, without tapping the picker. Only works while the app is open on this session; turn off to review each plan manually (and reach \"Clear context & execute\").",
  ...
  newSession: {
    ...
    sessionLabel: {
      title: "Session Label (Optional)",
      namePlaceholder: "Name this session (e.g. database-work, api-changes)",
      tagsPlaceholder: "Tags, comma-separated (e.g. backend, auth)",
    },
  },
  ...
  session: {
    ...
    queuePausedWithCount: ({ n }: { n: number }) => `Paused · ${n} message${n === 1 ? "" : "s"} queued`,
    sendNow: "Send now",
    pauseQueue: "Pause queue",
    resumeQueue: "Resume",
    queuedMessagePreview: "Message Preview",
    editQueuedMessage: "Edit message",
    editMode: "Edit",
    saveChanges: "Save",
    saveAndSendNow: "Save & send",
    cancelEdit: "Cancel",
    queueItemNotFound: "This message has already been sent or removed and can no longer be saved.",
    saveAndSendFailed: "Could not send the edited message. It has been kept in the queue so you can retry.",
    imagesCount: ({ n }: { n: number }) => `${n} image${n === 1 ? "" : "s"}`,
    charsCount: ({ n }: { n: number }) => `${n} char${n === 1 ? "" : "s"}`,
    ...
    codeExpandLines: ({ n }: { n: number }) => `Expand (${n} lines)`,
  ...
  sessionInfo: {
    ...
    worktreeActivity: "Worktree Activity",
    worktreeCreated: "Created worktree",
    worktreeRemoved: "Removed worktree",
    ...
    unarchiveSessionSubtitle:
      "Move this session back to active sessions without restarting it",
  ...
  agentInput: {
    ...
    effort: {
      ...
      max: "Max",
      maxDesc: "Only for truly hard problems — diminishing returns, may over-think",
    },
    thinking: {
      title: "THINKING",
      adaptive: "Adaptive",
  ...
  settingsAppLock: {
    title: "App Lock",
    enable: "App Lock",
    enableSubtitle: "Require a PIN to open the app on this device",
    changePin: "Change PIN",
    biometric: "Unlock with biometrics",
    biometricSubtitle: "Use Face ID, Touch ID, or fingerprint to unlock",
    timeout: "Require PIN",
    timeoutSubtitle: "Choose how long the app can be in the background before it locks again.",
    timeoutImmediate: "Immediately",
    timeout30s: "After 30 seconds",
    timeout1m: "After 1 minute",
    timeout5m: "After 5 minutes",
    timeoutNever: "Never",
    lockNow: "Lock now",
    footer: "App Lock controls access to this app on this device only. It does not change your account's end-to-end encryption.",
    setupTitle: "Set PIN",
    setupEnterNew: "Enter a new PIN",
    setupConfirm: "Confirm your PIN",
    setupHint: "Choose a 6-digit PIN",
    setupMismatch: "PINs didn't match. Try again.",
    unlockTitle: "Enter PIN",
    unlockPrompt: "Enter your PIN to unlock",
    incorrect: "Incorrect PIN",
    lockedOut: ({ seconds }: { seconds: number }) => `Too many attempts. Try again in ${seconds}s`,
    biometricPrompt: "Unlock Happy",
    biometricButton: "Use biometrics",
    forgotPin: "Forgot PIN?",
    forgotTitle: "Reset App Lock?",
    forgotMessage: "To reset your PIN you'll be logged out. Log back in to set a new one — your data stays safe.",
    forgotConfirm: "Log out",
    disableTitle: "Turn off App Lock?",
    disableMessage: "You'll no longer need a PIN or biometrics to open the app on this device.",
  ...
  machine: {
    ...
    automationGuardianFiltersHint: "Distinguish guardians that are currently attached, persisted for later reuse, or recovered after reconnection.",    automationQueued: "Queued",
    ...
    automationPipelineAllIdle: "All Idle",
    automationPipelineAllDone: "All Done",
    automationPipelineHealthy: "Healthy",
    ...
    agentLoopAIGenerate: "AI Generate Loops",
    agentLoopAISuggestionsTitle: "AI suggestions",
    agentLoopRepoSearch: "Search repositories…",
    agentLoopRepoEmpty: "No repositories found",
    ...
    bootstrapProfileEdit: "Edit Bootstrap profile",
    labelBootstrapRootDir: "Root Directory",
    agentLoopBootstrap: "Repo Bootstrap",
    agentLoopBootstrapHint: "Scan directories with existing loops for additional AI-generated configurations.",
    agentLoopBootstrapEmpty: "No loop directories found — create at least one loop to enable AI scanning.",
    agentLoopAIScanHint: "AI scan across your existing loop directories to find new configurations.",
    agentLoopSuggestionCount: ({ count }: { count: number }) => `${count} suggestions`,
    agentLoopCreatableCount: ({ count }: { count: number }) => `${count} creatable`,
  ...
  triggers: {
    ...
    profileSourceProjectDefault: "project default",
    profileEffective: ({ name, source }: { name: string; source: string }) => `Effective: ${name} (${source})`,
    name: "Name",
  ...
  dynamicWorkflows: {
    ...
    wave: ({ index }: { index: number }) => `Wave ${index}`,
  },
  ...
  githubPr: {
    ...
    truncated: "… diff truncated (too large)",
  },

  plan: {
    approve: "Approve plan",
    approveAutoEdits: "Approve & auto-approve edits",
    approveFreshContext: "Clear context & execute",
  ...
  projects: {
    ...
    tabConfig: "Config",
    tabTraces: "Traces",
    tracesEmpty: "No tool calls yet",
    tracesEmptySubtitle: "Tool calls will appear here during active sessions",
    tracesNoSession: "No active session",
    ...
    knowledgeConfigModeAutoHint: "Inject up to 5 entries ranked by keyword relevance to the current task. Best balance of context and token cost",
    knowledgeConfigModeFullHint: "Inject up to 20 entries per session. More context but higher token usage",
    knowledgeConfigModeMinimalHint: "Only inject the project profile (tech stack, conventions). No individual knowledge entries",
    knowledgeConfigSensitivity: "Collection Sensitivity",
    knowledgeConfigSensitivityConservativeHint: "Batch every 5 valuable turns or 60 min before extraction. Fewer but higher quality entries",
    knowledgeConfigSensitivityBalancedHint: "Batch every 3 valuable turns or 30 min. Good balance of coverage and noise",
    knowledgeConfigSensitivityAggressiveHint: "Extract after every valuable turn (10 min max). Most entries but more noise",
    knowledgeConfigCollection: "Collection Triggers",
    knowledgeConfigTrackFileEdits: "Track File Edits",
    knowledgeConfigTrackFileEditsHint: "When AI creates or modifies files → mark that turn as valuable. Batched every 3 turns before sending to server, not per-file",
    knowledgeConfigTrackTokens: "Track Deep Analysis",
    knowledgeConfigTrackTokensHint: "When a turn has no file edits but outputs >1500 tokens (deep reasoning, architecture planning) → also mark as valuable",
    knowledgeConfigSummary: "Session Summary",
    knowledgeConfigSummaryHint: "When session ends with ≥2 valuable turns → auto-generate one summary entry capturing the overall session arc. Refined by AI",
    ...
    knowledgeConfigMergeHint: "Find entries with ≥75% similarity, merge 2-5 per cluster (max 5 clusters/run) using AI. Source entries become 'superseded'. Runs every 6 hours",
    ...
    ciStatus: "CI Status",
    ciStatusEmpty: "No CI runs yet. Configure a GitHub webhook to see build status here.",
  },
  project: {
    segments: {
      board: "Board",
  ...
  preview: {
    ...
    annotate: "Annotate",
    sendFeedback: "Send to Session",
    feedbackSent: "Feedback sent to session",
  ...
  supervisor: {
    ...
    dimTypeSafety: "Type Safety",
    dimTypeSafetyNote: "any usage, unsafe assertions, missing null checks",
    dimObservability: "Observability",
    dimObservabilityNote: "Logging quality, error tracking, health checks",
    dimApiDesign: "API Design",
    dimApiDesignNote: "REST naming, status codes, validation consistency",
    dimBuildCI: "Build & CI",
    dimBuildCINote: "CI pipeline, build scripts, type checking in CI",
    dimPrReview: "PR Code Review",
    dimPrReviewNote: "Security, quality, and test coverage of PR changes",
    dimResearch: "Research",
    customDimensionsSection: "Custom Dimensions",
    customDimensionsAdd: "Add Dimension",
    customDimensionAddTitle: "Add Custom Dimension",
    customDimensionEditTitle: "Edit Dimension",
    customDimensionNameLabel: "Name",
    customDimensionNamePlaceholder: "e.g. API Design, Accessibility Audit",
    customDimensionPromptLabel: "Analysis Instructions",
    customDimensionPromptPlaceholder: "Describe what to check, what commands to run, and what patterns to look for...",
    customDimensionAiGenerate: "AI Generate",
    customDimensionAiGenerating: "Generating...",
    customDimensionDeleteConfirm: "Delete this custom dimension?",
    ...
    dimAiProfileSection: "Dimension AI Model",
    dimAiProfileDesc: "Model used when generating analysis prompts for custom dimensions",
    ...
    loopConfigMaxFailures: "Max consecutive failures",
    loopConfigMaxFailuresHint: ({ count }: { count: number }) => `Loop bails out after ${count} run${count === 1 ? "" : "s"} fail in a row`,
    loopConfigHealthTarget: "Health target",
    loopConfigHealthTargetHint: ({ value }: { value: number }) => `Exit when healthScore drops to ${value} or below`,
    loopConfigHealthTargetHintOff: "No health target set — loop exits via no_new_actions / goal_achieved / max_iterations / cost cap",
    loopConfigDuration: "Time limit",
    loopConfigDurationHint: ({ hours }: { hours: number }) => `Loop is forcibly completed after ${hours}h with the timeout exit reason`,
    ...
    loopExit_goal_achieved: "Goal achieved — consecutive clean passes",
  ...
  competitorResearch: {
    ...
    dim_integrationEffort: "Integration Complexity",
    dim_integrationEffort_note: "Effort to adopt competitor features into this codebase",
    dim_codeReusability: "Code Reusability",
    dim_codeReusability_note: "Patterns, APIs, algorithms reusable from competitors",
