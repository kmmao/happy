...
export const en: TranslationStructure = {
  ...
  machine: {
    ...
    automationQueuedHint: "Waiting to be dispatched into a session.",
    automationRunningHint: "Currently executing or being dispatched now.",
    automationGuardiansHint: "Saved continuity sessions available for reuse or reattachment.",
    ...
    automationLoopsTotalHint: "All loops currently configured on this machine.",
    automationLoopsActiveHint: "Loops that can still auto-run when triggers or schedules fire.",
    automationLoopsBlockedHint: "Loops paused by failures, policy, or a manual safety stop.",
    automationLoopsPausedHint: "Loops currently disabled and waiting to be resumed.",
    automationLoopsPendingEventsHint: "Loops holding queued events that have not been processed yet.",
    automationLoopsPolicyStoppedHint: "Loops recently stopped by policy or protection logic.",
    automationOpenLoopsHint: "Open loop configuration, triggers, and runtime state for this machine.",
    automationTotalAuditEventsHint: "Total number of local automation audit records stored on this machine.",
    automationGuardianReuseCountHint: "How many times an existing guardian session was reused instead of starting fresh.",
    automationGuardianReuseRateHint: "Share of eligible runs that successfully reused a guardian session.",
    automationGuardianResetCountHint: "How often stored guardian continuity had to be cleared and restarted.",
    automationSessionReattachedCountHint: "How many sessions were successfully reattached after an interruption or restart.",
    automationWatchdogStopsHint: "How many times the watchdog force-stopped a session for safety.",
