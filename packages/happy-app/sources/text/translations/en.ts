...
export const en: TranslationStructure = {
  ...
  settingsVoice: {
    ...
    voiceBackendDescription: "Choose the realtime voice engine used for live conversations.",
    livekitServerManagedNote: "No credentials configured — using server-managed LiveKit Cloud credentials. Add your own keys below for BYOK.",
    livekitConfig: "LiveKit Cloud",
    livekitConfigDescription: "Optional: provide your own LiveKit Cloud API Key, Secret, and WSS URL. Usage will be billed to your LiveKit account instead of the server's.",
    livekitApiKeyPlaceholder: "API Key (e.g. APIxxxxxxxx)",
    livekitApiSecretPlaceholder: "API Secret",
    livekitWssUrlPlaceholder: "WSS URL (e.g. wss://xxx.livekit.cloud)",
    livekitSaveVerify: "Save & Verify",
    livekitVerifying: "Verifying...",
    livekitVerified: "Verified",
    livekitVerifySuccess: "Connected — LiveKit credentials valid",
