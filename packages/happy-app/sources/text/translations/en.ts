...
export const en: TranslationStructure = {
  ...
  settingsVoice: {
    ...
    livekitConfigDescription: "Optional: provide your own LiveKit Cloud API Key and Secret. Usage will be billed to your LiveKit account instead of the server's.",
    ...
    ttsProviderDescription: "Choose how text is converted to speech. Free options require no setup.",
    ttsProviderWebSpeech: "Web Speech API",
    ttsProviderWebSpeechDescription: "Zero-cost browser-native TTS — no account required",
    ttsProviderWebSpeechNote: "Uses your device's built-in text-to-speech engine. Works instantly with no setup.",
    ttsProviderEdge: "Microsoft Edge TTS",
    ttsProviderEdgeDescription: "Free high-quality cloud TTS via Microsoft",
    ttsProviderEdgeNote: "Connects to Microsoft's TTS service. Free, no API key required.",
    ttsProviderVoicebox: "Voicebox (Local)",
    ttsProviderVoiceboxDescription: "High-quality local TTS — requires Voicebox running on your machine",
    ttsProviderElevenLabs: "ElevenLabs",
    ttsProviderElevenLabsDescription: "Premium AI voice — requires your own API key",
    voiceboxConfig: "Voicebox (Local)",
    voiceboxEndpointLabel: "Service URL",
    voiceboxEndpointPlaceholder: "http://localhost:17493",
    voiceboxEndpointDescription: "Local Voicebox TTS service URL. Requires Voicebox to be running on your machine.",
    voiceboxSave: "Save",
    voiceboxTest: "Test Connection",
    voiceboxTesting: "Testing...",
    voiceboxReady: "Connected",
    voiceboxSetupSuccess: "Voicebox connected and ready",
    voiceboxConnectionError: "Could not connect to Voicebox service",
  },
