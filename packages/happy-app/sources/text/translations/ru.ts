...
export const ru: TranslationStructure = {
  ...
  projects: {
    ...
    knowledgeConfigModeAutoHint: "Автоматически решает, сколько контекста внедрять на основе релевантности",
    knowledgeConfigModeFullHint: "Всегда внедрять все доступные знания в контекст сессии",
    knowledgeConfigModeMinimalHint: "Внедрять только критические знания — соглашения и предупреждения",
    knowledgeConfigSensitivity: "Чувствительность сбора",
    knowledgeConfigSensitivityConservativeHint: "Собирать только открытия и решения с высокой достоверностью",
    knowledgeConfigSensitivityBalancedHint: "Собирать большинство находок с умеренной фильтрацией",
    knowledgeConfigSensitivityAggressiveHint: "Собирать всё — включая наблюдения с низкой достоверностью",
    knowledgeConfigCollection: "Триггеры сбора",
    knowledgeConfigTrackFileEdits: "Отслеживать изменения файлов",
    knowledgeConfigTrackFileEditsHint: "Записывать знания при создании или изменении файлов",
    knowledgeConfigTrackToolCalls: "Отслеживать вызовы инструментов",
    knowledgeConfigTrackToolCallsHint: "Записывать знания из вызовов инструментов и их результатов",
    knowledgeConfigTrackTokens: "Отслеживать вывод токенов",
    knowledgeConfigTrackTokensHint: "Записывать знания из ответов ИИ-ассистента",
    knowledgeConfigLifecycle: "Жизненный цикл",
    knowledgeConfigRefine: "ИИ-обработка",
    knowledgeConfigRefineHint: "Использовать ИИ для улучшения, дедупликации и обогащения записей",
    knowledgeConfigDecay: "Автоархивация",
    knowledgeConfigDecayHint: "Автоматически архивировать записи, не используемые более 30 дней",
    knowledgeConfigMerge: "Умное слияние",
    knowledgeConfigMergeHint: "Периодически находить и объединять похожие записи с помощью ИИ",
