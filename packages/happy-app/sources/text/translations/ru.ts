...
export const ru: TranslationStructure = {
  ...
  agentInput: {
    ...
    context: {
      ...
      autoCompactOn: "200K",
      autoCompactOff: "1M",
      autoCompactHintOn: "Контекст 200K. Подсказка /compact при 75% (150K). Нажмите, чтобы переключиться на 1M.",
      autoCompactHintOff: "Контекст 1M. Без подсказок и сжатия. Нажмите, чтобы переключиться на 200K + подсказка при 75%.",
    },
    suggestion: {
      fileLabel: "ФАЙЛ",
      folderLabel: "ПАПКА",
