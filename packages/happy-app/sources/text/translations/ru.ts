...
export const ru: TranslationStructure = {
  ...
  errors: {
    ...
    voiceRealtimeFallback: "Realtime-шлюз недоступен — этот разговор переключён на ElevenLabs",
  ...
  settingsVoice: {
    ...
    providerDescription: "Выберите бэкенд для голосовых разговоров.",
    providerElevenLabs: "ElevenLabs",
    providerElevenLabsSubtitle: "Управляемый агент, доступен на всех платформах",
    providerRealtime: "Realtime-шлюз",
    providerRealtimeSubtitle: "Эндпоинт, совместимый с OpenAI Realtime",
    realtimeGatewayConfig: "Realtime-шлюз",
    realtimeGatewayDescription: "Базовый URL шлюза, совместимого с OpenAI Realtime, например экземпляра sub2api. API-ключ отправляется как Bearer token.",
    realtimeGatewayUrl: "Базовый URL",
    realtimeGatewayUrlPlaceholder: "https://gateway.example.com",
    realtimeGatewayApiKey: "API Key",
    realtimeGatewayApiKeyPlaceholder: "sk-...",
    realtimeVoice: "Голос",
    realtimeVoicePlaceholder: "Оставьте пустым для значения по умолчанию",
  },
