...
export const ru: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    knowledgeBaseSensitivityConservative: "Консервативный — меньше, но качественнее",
    knowledgeBaseSensitivityBalanced: "Сбалансированный — пороги по умолчанию",
    knowledgeBaseSensitivityAggressive: "Агрессивный — собирать больше знаний",
