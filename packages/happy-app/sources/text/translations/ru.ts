...
export const ru: TranslationStructure = {
  ...
  settingsVoice: {
    ...
    voiceBackendTitle: "Голосовой бэкенд реального времени",
    ...
    livekitConfigDescription: "Необязательно: укажите свои LiveKit Cloud API Key, Secret и WSS URL. Использование будет тарифицироваться на вашем аккаунте LiveKit, а не на серверном.",
    livekitApiKeyPlaceholder: "API Key (например, APIxxxxxxxx)",
    livekitApiSecretPlaceholder: "API Secret",
    livekitWssUrlPlaceholder: "WSS URL (напр. wss://xxx.livekit.cloud)",
    ...
    livekitProject: "Проект",
    livekitActiveRooms: "Активные комнаты",
    livekitMode: "Режим",
    livekitParticipants: "участников",
    livekitViewUsage: "Посмотреть использование в LiveKit Cloud",
