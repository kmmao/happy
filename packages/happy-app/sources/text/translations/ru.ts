...
export const ru: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    worldModelEnabled: "Вкладки мировой модели видны в проектах",
    worldModelDisabled: "Вкладки мировой модели скрыты",
    ...
    knowledgeBaseMode: "Режим базы знаний",
    knowledgeBaseModeAuto: "Авто — внедрение контекста по необходимости",
    knowledgeBaseModeFull: "Полный — всегда внедрять весь контекст",
    knowledgeBaseModeMinimal: "Минимальный — только самое необходимое",
    knowledgeBaseSensitivity: "Чувствительность сбора",
    knowledgeBaseSensitivityConservative: "Консервативный — 5 ходов / 60 мин, инструменты > 8, токены > 800",
    knowledgeBaseSensitivityBalanced: "Сбалансированный — 3 хода / 30 мин, инструменты > 5, токены > 500",
    knowledgeBaseSensitivityAggressive: "Агрессивный — 1 ход / 10 мин, инструменты > 3, токены > 200",
    knowledgeBaseTrackFileEdits: "Отслеживать редактирование файлов",
    knowledgeBaseTrackFileEditsSubtitle: "Собирать знания при создании или редактировании файлов",
    knowledgeBaseTrackToolCalls: "Отслеживать вызовы инструментов",
    knowledgeBaseTrackToolCallsSubtitle: "Собирать знания при большом количестве вызовов",
    knowledgeBaseTrackTokens: "Отслеживать вывод токенов",
  ...
  agentInput: {
    ...
    effort: {
      ...
      xhigh: "Сверхвысокий",
      xhighDesc: "Рекомендовано для задач, требующих интеллекта (Opus 4.7)",
      max: "Максимальный",
  ...
  machine: {
    ...
    automationGuardiansHint: "Сессии для повторного использования",
    ...
    automationGuardianReuseCountHint: "Повторно использованы вместо новых",
    automationGuardianReuseRateHint: "Доля успешного повторного использования",
    automationGuardianResetCountHint: "Очищены и перезапущены",
    ...
    automationGuardianUsageHint: "Показывает, как часто каждый ключ Guardian переиспользовался, запоминался или сбрасывался.",
    automationClearAuditHint: "Удаляет локальные записи аудита, сохраняя текущие задачи и состояние Guardian.",
    automationAuditHint: "Недавние события уровня машины о решениях автоматизации, непрерывности Guardian и аномалиях.",
    automationTimelineHint: "Хронологический обзор недавних этапов жизненного цикла задач.",
    automationAlertsHint: "Сначала показывает проблемы, которые, скорее всего, потребуют ручного внимания — например, аномалии или Guardian, которые нужно восстановить.",
    ...
    automationOverviewHint: "Используйте эту страницу, чтобы понять текущие задачи, непрерывность Guardian, здоровье loops и сигналы аудита до перехода к деталям.",
    ...
    automationSearchHint: "Ищите по имени задачи, ключу Guardian, ID сессии, ID loop, ID проекта или тексту ошибки.",
    automationJobFiltersHint: "Сфокусируйте список задач по стадии выполнения: выполняются, упали, завершены или восстановлены.",
    automationAuditFiltersHint: "Сузьте события аудита до аномалий, непрерывности Guardian, жизненного цикла задачи или событий восстановления.",
    automationGuardianFiltersHint: "Различайте Guardian, которые сейчас присоединены, сохранены для повторного использования позже или восстановлены после переподключения.",
    ...
    automationSectionGuardians: "Состояние непрерывности сессий",
    automationSectionAuditStats: "Метрики здоровья из аудита",
    automationSectionGuardianUsage: "История повторного использования guardian",
    ...
    agentLoopBootstrapHint: "Сканируйте репозитории на этой машине, генерируйте loop-планы и создавайте их пакетно.",
    agentLoopBootstrapEmpty: "Пока нет репозиториев, готовых к bootstrap — просканируйте машину, чтобы найти кандидатов",
  ...
  world: {
    ...
    categoryProcess: "Процесс",
    categoryOps: "Эксплуатация",
    ...
    deleteLawConfirmBody: "Вы уверены, что хотите удалить этот закон?",
    dashboardTitle: "Обзор мира",
    autonomyScore: "Автономность",
    autonomyScoreDesc: "Решения, автоматически принятые за последние 30 дней",
    activeGroups: "Активные группы",
    pendingDecisions: "Ожидающие решения",
    goalsOverview: "Цели",
    goalsActive: "Активные",
    goalsCompleted: "Завершённые",
    goalsBlocked: "Заблокированные",
    recentDecisions: "Недавние решения",
    agentMessages: "Сообщения Agent",
    noDataYet: "Данных о мире пока нет",
    noDataHint: "Настройте нарратив, законы и роли для включения World Model",
    lawCount: "Законы",
    lawSuggestions: "Предложения законов",
    conflicts: "Конфликты",
    fullyAutonomous: "Полная автономность",
    needsAttention: "Требует внимания",
    notApplicable: "N/A",
    autonomyDecided: "решено",
    autonomyAuto: "авто",
    ...
    generateSuccess: "Элементы мира сгенерированы — проверьте и сохраните",
    generateError: "Не удалось сгенерировать элементы мира",
    generateConfirmTitle: "Перезаписать существующее содержимое?",
    generateConfirmBody: "Текущий нарратив и правила будут заменены автоматически сгенерированным содержимым. Вы можете проверить перед сохранением.",
    generateSkipped: "Пропущено (данные уже существуют)",
    generatePartialError: "Частичные ошибки",
    modeAuto: "Умная инициализация",
    modeCustom: "Пользовательская",
    modeAutoHint: "Автоматически заполняет только отсутствующие части — существующие нарратив, правила, роли и цели будут сохранены.",
    modeCustomHint: "Опишите этот мир или вставьте контекст, и мы сгенерируем все элементы мира на основе вашего ввода.",
    customPromptPlaceholder: "Опишите видение этого мира, технологический стек, структуру команды или вставьте README...",
    ...
    generateAutoAction: "Инициализировать мир",
    generateCustomAction: "Сгенерировать из описания",
    goalHealth: "Здоровье цели",
    avgHealthScore: "Средний балл",
    worldAlias: "Название мира",
    worldAliasDescription: "Пользовательское отображаемое имя для этого мира",
    worldAliasNotSet: "Не задано",
    worldAliasPromptTitle: "Название мира",
    worldAliasPromptMessage: "Введите пользовательское название для этого мира",
    worldTerminate: "Завершить мир",
    worldTerminateConfirm: "Вы уверены, что хотите завершить этот мир? Он будет скрыт из списка.",
    worldRevive: "Возродить мир",
    worldReviveConfirm: "Вы уверены, что хотите возродить этот мир?",
  },
  suggestions: {
    suggestedNextSteps: "Рекомендуемые действия",
    noSuggestions: "Пока нет предложений",
    noSuggestionsHint: "Предложения появятся, когда цели заблокированы или задачи провалились",
    refresh: "Обновить",
    refreshing: "Обновление...",
    accept: "Принять",
    dismiss: "Отклонить",
    acceptConfirmTitle: "Принять предложение",
  ...
  governance: {
    title: "Управление",
    policyMode: "Режим автономии",
    policyModeDesc: "Управляет автономным поведением мира",
    modeDisabledDesc: "Без автоматических действий",
    modeSuggestDesc: "Только предложения, вы решаете",
    modeSemiAutoDesc: "Авто-принятие безопасных задач",
    modeAutoDesc: "Авто-принятие задач и целей",
    autoAcceptTypes: "Типы авто-принятия",
    typeTask: "Задачи",
    typeGoal: "Цели",
    typeDecision: "Решения (с прецедентом)",
    auditLog: "Аудит автоматизации",
    auditEmpty: "Нет автоматически принятых действий",
    auditVeto: "Вето",
    auditVetoConfirmTitle: "Вето на автодействие",
    auditVetoConfirmBody: "Это отменит автоматически выполненное действие. Вы уверены?",
    auditVetoed: "Действие отклонено",
    auditVetoFailed: "Не удалось применить вето",
    auditWindowExpired: "Окно вето истекло",
    auditAutoResolved: "Авто-разрешено",
    auditAutoAccepted: "Авто-принято",
  },
  collaboration: {
    title: "Взаимодействие групп",
    noBlocks: "Нет активных блокировок",
    blockedChains: "Цепочки блокировок",
    openConflicts: "Открытые конфликты",
    pendingDecisions: "Ожидающие решения",
    groupActivity: "Активность групп",
    waitingFor: ({ role }: { role: string }) => `Ожидание ${role}`,
    handoffs: "Передачи",
    reviewRequests: "Проверки",
    dependencyBlocked: "Заблокирован",
    chainLabel: ({ chain }: { chain: string }) => `Цепочка: ${chain}`,
  ...
  roles: {
    ...
    dutiesCount: ({ count }: { count: number }) => `${count} обязанн.`,
    skillsCount: ({ count }: { count: number }) => `${count} навык.`,
  ...
  members: {
    ...
    emptyState: "Участников пока нет. Добавьте участников для совместного принятия решений.",
    usernameLabel: "Имя пользователя",
    usernamePlaceholder: "Введите имя пользователя для приглашения",
    roleLabel: "Уровень прав",
    roleOwner: "Владелец",
    roleAdmin: "Администратор",
    roleMember: "Участник",
    roleObserver: "Наблюдатель",
    expertiseLabel: "Экспертиза",
    expertisePlaceholder: "Добавить тег экспертизы...",
    lawAuthorityLabel: "Полномочия по правилам",
    lawCreate: "Создание",
    lawSuggest: "Только предложения",
    lawReadonly: "Только чтение",
    decisionScopeLabel: "Область решений",
    decisionAll: "Все решения",
    decisionAssigned: "Только назначенные",
    decisionNone: "Нет",
    goalAuthorityLabel: "Полномочия по целям",
    goalCreate: "Создание",
    goalSuggest: "Только предложения",
    goalReadonly: "Только чтение",
    notifyLevelLabel: "Уведомления",
    notifyAll: "Все",
    notifyCritical: "Только критические",
    notifyAssigned: "Только назначенные",
    notifyNone: "Нет",
    availabilityLabel: "Доступность",
    availabilityActive: "Активен",
    availabilityAway: "Отсутствует",
    availabilityDelegate: "Делегирование",
    delegateToLabel: "Делегировать",
    saved: "Участник сохранён",
    saveError: "Не удалось сохранить участника",
    removed: "Участник удалён",
    removeConfirmTitle: "Удалить участника",
    removeConfirmBody: "Вы уверены, что хотите удалить этого участника? Он потеряет доступ к мировой модели проекта.",
    cannotRemoveOwner: "Невозможно удалить владельца проекта",
    memberAlreadyExists: "Этот пользователь уже является участником",
    userNotFound: "Пользователь не найден",
  ...
  goals: {
    ...
    goalDescriptionPlaceholder: "Укажите подробности об этой цели...",
    ...
    priorityLow: "Низкий",
    emptyGoals: "Целей пока нет",
    emptyGoalsHint: "Создайте цель, и система автоматически разложит её на задачи",
    autoDecompose: "Автоматически разложить на задачи",
    tasks: ({ count }: { count: number }) => `${count} ${count === 1 ? "задача" : "задач"}`,
    subGoals: ({ count }: { count: number }) => `${count} ${count === 1 ? "подцель" : "подцелей"}`,
    cancelGoal: "Отменить цель",
    cancelGoalConfirm: "Все активные задачи будут отменены. Продолжить?",
    plannerWorking: "Планировщик выполняет декомпозицию...",
    ...
    decomposeTriggered: "Декомпозиция запущена",
    decomposeError: "Не удалось запустить декомпозицию",
    viewSession: "Открыть сессию",
    taskIndex: ({ index }: { index: number }) => `Задача #${index}`,
    ...
    deleteGoalConfirm: "Удалить эту цель навсегда?",
    deleted: "Цель удалена",
    healthScore: "Здоровье",
    healthCritical: "Критическое",
    healthWarning: "Нездоровое",
    healthHealthy: "Здоровое",
    layerStrategic: "Стратегический",
    layerOperational: "Операционный",
    layerExecution: "Исполнительный",
    replan: "Перепланировать",
    replanConfirm: "Отменить активные задачи и повторно декомпозировать эту цель?",
  ...
  decision: {
    ...
    autoResolved: "Автоматически разрешено",
    adjudicateError: "Не удалось принять решение",
    assignedTo: "Назначено",
    opinions: "Мнения",
    submitOpinion: "Отправить мнение",
    opinionSubmitted: "Мнение отправлено",
    opinionConflict: "Мнения расходятся — передано администратору",
