...
export const ru: TranslationStructure = {
  ...
  machine: {
    ...
    automationQueuedHint: "Ожидает отправки в сессию.",
    automationRunningHint: "Сейчас выполняется или прямо сейчас отправляется в сессию.",
    automationGuardiansHint: "Сохранённые сессии непрерывности, доступные для повторного использования или повторного присоединения.",
    ...
    automationLoopsTotalHint: "Все loops, которые сейчас настроены на этой машине.",
    automationLoopsActiveHint: "Loops, которые всё ещё могут запускаться автоматически при срабатывании trigger'ов или расписаний.",
    automationLoopsBlockedHint: "Loops, остановленные из-за ошибок, политики или ручной безопасной остановки.",
    automationLoopsPausedHint: "Loops, которые сейчас отключены и ждут возобновления.",
    automationLoopsPendingEventsHint: "Loops с событиями в очереди, которые ещё не обработаны.",
    automationLoopsPolicyStoppedHint: "Loops, недавно остановленные политикой или логикой защиты.",
    automationOpenLoopsHint: "Открыть конфигурацию loops, trigger'ы и состояние выполнения для этой машины.",
    automationTotalAuditEventsHint: "Общее число локальных записей аудита автоматизации, сохранённых на этой машине.",
    automationGuardianReuseCountHint: "Сколько раз существующая сессия Guardian была повторно использована вместо старта с нуля.",
    automationGuardianReuseRateHint: "Доля подходящих запусков, в которых удалось повторно использовать сессию Guardian.",
    automationGuardianResetCountHint: "Как часто сохранённую непрерывность Guardian приходилось очищать и запускать заново.",
    automationSessionReattachedCountHint: "Сколько сессий удалось успешно заново присоединить после прерывания или перезапуска.",
    automationWatchdogStopsHint: "Сколько раз watchdog принудительно останавливал сессию ради безопасности.",
