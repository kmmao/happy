...
export const ja: TranslationStructure = {
  ...
  errors: {
    ...
    voiceRealtimeFallback: "Realtime ゲートウェイが利用できないため、この会話は ElevenLabs に切り替えました",
  ...
  settingsVoice: {
    ...
    providerDescription: "音声会話を担当するバックエンドを選択します。",
    providerElevenLabs: "ElevenLabs",
    providerElevenLabsSubtitle: "マネージドエージェント、全プラットフォーム対応",
    providerRealtime: "Realtime ゲートウェイ",
    providerRealtimeSubtitle: "OpenAI Realtime 互換エンドポイント",
    realtimeGatewayConfig: "Realtime ゲートウェイ",
    realtimeGatewayDescription: "sub2api インスタンスなど、OpenAI Realtime 互換ゲートウェイのベース URL。API Key は Bearer token として送信されます。",
    realtimeGatewayUrl: "ベース URL",
    realtimeGatewayUrlPlaceholder: "https://gateway.example.com",
    realtimeGatewayApiKey: "API Key",
    realtimeGatewayApiKeyPlaceholder: "sk-...",
    realtimeVoice: "ボイス",
    realtimeVoicePlaceholder: "空欄の場合はゲートウェイの既定値を使用",
  },
