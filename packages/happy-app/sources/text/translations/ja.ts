...
export const ja: TranslationStructure = {
  ...
  projects: {
    ...
    knowledgeConfigModeAutoHint: "関連性に基づいて注入するコンテキスト量を自動的に決定",
    knowledgeConfigModeFullHint: "利用可能なすべてのナレッジを常にセッションに注入",
    knowledgeConfigModeMinimalHint: "重要なナレッジのみ注入 — 規約と警告",
    knowledgeConfigSensitivity: "収集感度",
    knowledgeConfigSensitivityConservativeHint: "高信頼度の発見と決定のみ収集",
    knowledgeConfigSensitivityBalancedHint: "中程度の信頼度フィルタリングで大半の発見を収集",
    knowledgeConfigSensitivityAggressiveHint: "すべてを収集 — 低信頼度の観察を含む",
    knowledgeConfigCollection: "収集トリガー",
    knowledgeConfigTrackFileEdits: "ファイル編集を追跡",
    knowledgeConfigTrackFileEditsHint: "ファイルの作成や変更時にナレッジを記録",
    knowledgeConfigTrackToolCalls: "ツール呼び出しを追跡",
    knowledgeConfigTrackToolCallsHint: "ツール呼び出しとその結果からナレッジを記録",
    knowledgeConfigTrackTokens: "トークン出力を追跡",
    knowledgeConfigTrackTokensHint: "AIアシスタントの応答からナレッジを記録",
    knowledgeConfigLifecycle: "ライフサイクル",
    knowledgeConfigRefine: "AI精製",
    knowledgeConfigRefineHint: "AIを使用して新しいナレッジの改善、重複排除、充実化",
    knowledgeConfigDecay: "自動アーカイブ",
    knowledgeConfigDecayHint: "30日以上アクセスされていない古いエントリを自動アーカイブ",
    knowledgeConfigMerge: "スマートマージ",
    knowledgeConfigMergeHint: "AIを使用して類似のナレッジエントリを定期的に検索・統合",
