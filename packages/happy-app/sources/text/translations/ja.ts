...
export const ja: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    worldModel: "ワールドモデル",
    worldModelEnabled: "プロジェクトにワールドモデルタブを表示",
    worldModelDisabled: "ワールドモデルタブを非表示",
    ...
    knowledgeBaseMode: "ナレッジベースモード",
    knowledgeBaseModeAuto: "自動 — 必要に応じてコンテキストを注入",
    knowledgeBaseModeFull: "フル — 常にすべてのコンテキストを注入",
    knowledgeBaseModeMinimal: "ミニマル — 必要最低限のみ注入",
    knowledgeBaseSensitivity: "収集感度",
    knowledgeBaseSensitivityConservative: "控えめ — 5ターン / 60分、ツール > 8、トークン > 800",
    knowledgeBaseSensitivityBalanced: "バランス — 3ターン / 30分、ツール > 5、トークン > 500",
    knowledgeBaseSensitivityAggressive: "積極的 — 1ターン / 10分、ツール > 3、トークン > 200",
    knowledgeBaseTrackFileEdits: "ファイル編集を追跡",
    knowledgeBaseTrackFileEditsSubtitle: "ファイルの作成・編集時にナレッジを収集",
    knowledgeBaseTrackToolCalls: "ツール呼び出しを追跡",
    knowledgeBaseTrackToolCallsSubtitle: "多数のツール呼び出し時にナレッジを収集",
    knowledgeBaseTrackTokens: "トークン出力を追跡",
    knowledgeBaseTrackTokensSubtitle: "長いAI応答からナレッジを収集",
    knowledgeBaseFooter: "変更は新しいセッションで有効になります。実行中のセッションには影響しません。",
    knowledgeBaseAllTracksOff: "すべての収集トリガーが無効です。少なくとも1つを有効にしないとナレッジは収集されません。",
  ...
  machine: {
    ...
    automationGuardianResetCountHint: "クリアして再起動",
    ...
    automationGuardianUsageHint: "各 Guardian キーがどれだけ再利用・記憶・リセットされたかを表示します。",
    automationClearAuditHint: "現在のジョブや Guardian 状態を保ったままローカル監査記録を削除します。",
    automationAuditHint: "自動化判断、Guardian 継続性、異常に関する最近のマシンレベルイベントです。",
    automationTimelineHint: "最近のジョブライフサイクルの主要な節目を時系列で表示します。",
    automationAlertsHint: "異常や復旧が必要な Guardian など、手動対応が必要そうな問題を優先表示します。",
    ...
    automationOverviewHint: "詳細を見る前に、現在のジョブ、Guardian 継続性、Loop の健全性、監査シグナルを把握するためのページです。",
    ...
    automationSearchHint: "ジョブ名、Guardian キー、セッション ID、Loop ID、プロジェクト ID、エラーテキストで検索できます。",
    automationJobFiltersHint: "実行段階ごとにジョブ一覧を絞り込みます：実行中、失敗、完了、復旧済み。",
    automationAuditFiltersHint: "監査イベントを異常、Guardian 継続性、ジョブライフサイクル、復旧イベントに絞り込みます。",
    automationGuardianFiltersHint: "現在アタッチ中、後で再利用するために保存済み、再接続後に復旧した Guardian を区別します。",
    ...
    automationSectionGuardians: "永続セッションの継続性状態",
    automationSectionAuditStats: "監査イベントに基づく健全性指標",
    automationSectionGuardianUsage: "各 Guardian キーの再利用履歴",
    ...
    agentLoopBootstrapHint: "このマシン上のリポジトリをスキャンし、loop プランを生成して一括作成します。",
    agentLoopBootstrapEmpty: "まだ bootstrap 対象のリポジトリはありません — このマシンをスキャンして候補を探してください",
  ...
  world: {
    title: "ワールド憲法",
    narrativeLabel: "ワールドナラティブ",
    narrativePlaceholder: "このワールドのビジョン、目標、アイデンティティを記述...",
    narrativeDesc: "Supervisorが分析時にこのナラティブを参照し、このワールドの目的を理解します。",
    lawsLabel: "法則",
    addLaw: "法則を追加",
    editLaw: "法則を編集",
    deleteLaw: "削除",
    ...
    lawSeverity: "重大度",
    lawEnabled: "有効",
    emptyLaws: "法則がまだ定義されていません。法則を追加してSupervisorの分析をガイドしましょう。",
    save: "保存",
    saved: "ワールド憲法を保存しました",
    saveError: "ワールド憲法の保存に失敗しました",
    categoryQuality: "品質",
    categorySecurity: "セキュリティ",
    categoryArchitecture: "アーキテクチャ",
    categoryConvention: "規約",
    ...
    severityMedium: "中",
    severityLow: "低",
    deleteLawConfirmTitle: "法則を削除",
    deleteLawConfirmBody: "この法則を削除してもよろしいですか？",
    dashboardTitle: "ワールド概要",
    autonomyScore: "自律度",
    autonomyScoreDesc: "過去30日間に自動裁決された決定",
    ...
    agentMessages: "Agent メッセージ",
    noDataYet: "ワールドデータがありません",
    noDataHint: "ナラティブ、法則、ロールを設定して World Model を有効にしてください",
    lawCount: "法則",
    lawSuggestions: "法則の提案",
    conflicts: "コンフリクト",
    fullyAutonomous: "完全自律",
    needsAttention: "要対応",
    notApplicable: "N/A",
    autonomyDecided: "裁定済み",
    autonomyAuto: "自動",
    autonomyPending: "保留中",
    ...
    generateAction: "生成",
    generateSuccess: "ワールド要素を生成しました — 確認して保存してください",
    generateError: "ワールド要素の生成に失敗しました",
    generateConfirmTitle: "既存の内容を上書きしますか？",
    generateConfirmBody: "現在のナラティブと法則が自動生成された内容に置き換わります。保存前に確認できます。",
    generateSkipped: "スキップ（既にデータあり）",
    generatePartialError: "一部の作成に失敗",
    modeAuto: "スマート初期化",
    modeCustom: "カスタム生成",
    modeAutoHint: "不足している部分のみ自動補完します。既存のナラティブ、法則、ロール、ゴールは保持されます。",
    modeCustomHint: "このワールドの説明を入力するか関連コンテンツを貼り付けてください。入力に基づいて全ワールド要素を生成します。",
    customPromptPlaceholder: "このワールドのビジョン、技術スタック、チーム構成を記述、またはREADMEを貼り付け...",
    goalModeTitle: "目標初期化モード",
    goalModeDraft: "目標を草案としてのみ作成（デフォルト）",
    goalModeAutoDecompose: "目標を作成して自動分解（推奨）",
    goalModeDraftHint: "手動で分解を開始するまで、目標は「計画中（待機）」のままです。",
    goalModeAutoDecomposeHint: "作成直後にプランナーを起動し、実行可能なタスクへ分解します。",
    generateAutoAction: "ワールドを初期化",
    generateCustomAction: "説明から生成",
    goalHealth: "ゴールヘルス",
    avgHealthScore: "平均スコア",
    worldAlias: "ワールド名",
    worldAliasDescription: "このワールドのカスタム表示名",
    worldAliasNotSet: "未設定",
    worldAliasPromptTitle: "ワールド名",
    worldAliasPromptMessage: "このワールドのカスタム名を入力してください",
    worldTerminate: "ワールドを終結",
    worldTerminateConfirm: "このワールドを終結しますか？リストから非表示になります。",
    worldRevive: "ワールドを復活",
    worldReviveConfirm: "このワールドを復活しますか？",
  },
  suggestions: {
    suggestedNextSteps: "次のステップの提案",
    noSuggestions: "現在提案はありません",
    noSuggestionsHint: "目標がブロックされたりタスクが失敗した場合に提案が表示されます",
    refresh: "更新",
    refreshing: "更新中...",
    accept: "承認",
    dismiss: "却下",
    acceptConfirmTitle: "提案を承認",
  ...
  governance: {
    title: "ガバナンス",
    policyMode: "自律モード",
    policyModeDesc: "ワールドの自律動作を制御します",
    modeDisabledDesc: "自動アクションなし",
    modeSuggestDesc: "提案のみ、判断はユーザーが行います",
    modeSemiAutoDesc: "安全なタスクを自動承認",
    modeAutoDesc: "タスクと目標を自動承認",
    autoAcceptTypes: "自動承認タイプ",
    typeTask: "タスク",
    typeGoal: "目標",
    typeDecision: "意思決定（先例あり）",
    auditLog: "自動化監査",
    auditEmpty: "自動承認されたアクションはありません",
    auditVeto: "拒否",
    auditVetoConfirmTitle: "自動アクションを拒否",
    auditVetoConfirmBody: "自動実行されたアクションをキャンセルします。よろしいですか？",
    auditVetoed: "アクションを拒否しました",
    auditVetoFailed: "拒否に失敗しました",
    auditWindowExpired: "拒否期間が終了しました",
    auditAutoResolved: "自動解決",
    auditAutoAccepted: "自動承認",
  },
  collaboration: {
    title: "グループ連携",
    noBlocks: "アクティブなブロックなし",
    blockedChains: "ブロックチェーン",
    openConflicts: "未解決の競合",
    pendingDecisions: "保留中の決定",
    groupActivity: "グループ活動",
    waitingFor: ({ role }: { role: string }) => `${role}を待機中`,
    handoffs: "ハンドオフ",
    reviewRequests: "レビュー",
    dependencyBlocked: "ブロック中",
    chainLabel: ({ chain }: { chain: string }) => `チェーン: ${chain}`,
    auditLog: "監査ログ",
    viewMore: "もっと見る",
  },
  roles: {
    ...
    typeLabel: "タイプ",
    descriptionLabel: "説明",
    descriptionPlaceholder: "このロールの動作と指示を記述...",
    dutiesLabel: "職責",
    dutiesPlaceholder: "職責を追加...",
    addDuty: "職責を追加",
    skillsLabel: "バインドスキル",
    enabledLabel: "有効",
    emptyState: "ロールがまだ定義されていません。ロールを作成してAgent Loopに異なるアイデンティティを付与しましょう。",
    deleteConfirmTitle: "ロールを削除",
    deleteConfirmBody: "このロールを削除してもよろしいですか？このロールを使用しているAgent Loopはロールアイデンティティなしで動作を続けます。",
    saved: "ロールを保存しました",
    saveError: "ロールの保存に失敗しました",
    deleted: "ロールを削除しました",
    templateLabel: "テンプレートを使用",
    dutiesCount: ({ count }: { count: number }) => `${count} 件の職責`,
    skillsCount: ({ count }: { count: number }) => `${count} 件のスキル`,
    typeGuardian: "ガーディアン",
    typeBuilder: "ビルダー",
    typeHealer: "ヒーラー",
    typeChronicler: "クロニクラー",
    typePlanner: "プランナー",
    typeMessenger: "メッセンジャー",
    typeCustom: "カスタム",
  ...
  members: {
    ...
    editMember: "メンバー編集",
    removeMember: "メンバー削除",
    emptyState: "チームメンバーがまだいません。メンバーを追加して共同意思決定を有効にしましょう。",
    usernameLabel: "ユーザー名",
    usernamePlaceholder: "招待するユーザー名を入力",
    roleLabel: "権限レベル",
    roleOwner: "オーナー",
    roleAdmin: "管理者",
    roleMember: "メンバー",
    roleObserver: "オブザーバー",
    expertiseLabel: "専門分野",
    expertisePlaceholder: "専門タグを追加...",
    lawAuthorityLabel: "法則権限",
    lawCreate: "作成",
    lawSuggest: "提案のみ",
    lawReadonly: "読み取り専用",
    decisionScopeLabel: "決定範囲",
    decisionAll: "すべての決定",
    decisionAssigned: "割り当てのみ",
    decisionNone: "なし",
    goalAuthorityLabel: "目標権限",
    goalCreate: "作成",
    goalSuggest: "提案のみ",
    goalReadonly: "読み取り専用",
    notifyLevelLabel: "通知",
    notifyAll: "すべて",
    notifyCritical: "重要のみ",
    notifyAssigned: "割り当てのみ",
    notifyNone: "なし",
    availabilityLabel: "可用性",
    availabilityActive: "オンライン",
    availabilityAway: "離席",
    availabilityDelegate: "委任",
    delegateToLabel: "委任先",
    saved: "メンバーを保存しました",
    saveError: "メンバーの保存に失敗しました",
    removed: "メンバーを削除しました",
    removeConfirmTitle: "メンバー削除",
    removeConfirmBody: "このメンバーを削除してもよろしいですか？このプロジェクトのワールドモデルへのアクセスが失われます。",
    cannotRemoveOwner: "プロジェクトオーナーは削除できません",
    memberAlreadyExists: "このユーザーはすでにメンバーです",
    userNotFound: "ユーザーが見つかりません",
  ...
  goals: {
    ...
    createGoal: "新規ゴール",
    goalTitle: "タイトル",
    goalTitlePlaceholder: "何を達成したいですか？",
    goalDescription: "説明",
    goalDescriptionPlaceholder: "このゴールの詳細を記入してください...",
    goalPriority: "優先度",
    goalDeadline: "期限",
    goalMachine: "マシン",
    statusPlanning: "計画中",
    statusPlanningPending: "計画中（分解待ち）",
    statusPlanningRunning: "計画中（分解中）",
    ...
    priorityNormal: "通常",
    priorityLow: "低",
    emptyGoals: "ゴールはまだありません",
    emptyGoalsHint: "ゴールを作成すると、システムが自動的にタスクに分解します",
    autoDecompose: "タスクに自動分解",
    tasks: ({ count }: { count: number }) => `${count} 件のタスク`,
    subGoals: ({ count }: { count: number }) => `${count} 件のサブゴール`,
    cancelGoal: "ゴールをキャンセル",
    cancelGoalConfirm: "すべてのアクティブなタスクがキャンセルされます。続行しますか？",
    plannerWorking: "プランナーが分解中...",
    plannerCountdown: ({ time }: { time: string }) => `remaining ${time}`,
    plannerPending: "プランナーはまだ開始していません",
    plannerTimeoutBlocked: "分解結果が返っていません（タイムアウト）",
    startDecompose: "分解を開始",
    retryDecompose: "分解を再試行",
    decomposeTriggered: "分解をトリガーしました",
    decomposeError: "分解のトリガーに失敗しました",
    viewSession: "セッションを表示",
    taskIndex: ({ index }: { index: number }) => `タスク #${index}`,
    progress: ({ value }: { value: number }) => `${value}%`,
    created: "ゴールを作成しました",
    createError: "ゴールの作成に失敗しました",
    cancelled: "ゴールをキャンセルしました",
    deleteGoal: "ゴールを削除",
    deleteGoalConfirm: "このゴールを完全に削除しますか？",
    deleted: "ゴールを削除しました",
    healthScore: "ヘルス",
    healthCritical: "危機的",
    healthWarning: "不健全",
    ...
    layerExecution: "実行",
    replan: "再計画",
    replanConfirm: "アクティブなタスクをキャンセルしてこのゴールを再分解しますか？",
  ...
  decision: {
    ...
    cons: "デメリット",
    adjudicate: "裁定",
    adjudicateConfirm: "裁定を確認",
    rationale: "理由（任意）",
    rationalePlaceholder: "なぜこのオプションを選びましたか？",
    precedentGenerated: "判例がナレッジベースに保存されました",
    viewPrecedent: "判例を表示",
    expiresIn: "残り時間",
    expiredAt: "期限切れ",
    ...
    autoResolved: "自動裁定",
    adjudicateError: "裁定に失敗しました",
    assignedTo: "割り当て済み",
    opinions: "意見",
    submitOpinion: "意見を送信",
    opinionSubmitted: "意見が送信されました",
    opinionConflict: "意見が対立 — 管理者にエスカレーション",
    emptyState: "保留中の裁定はありません",
    title: "裁定",
  },
} as const;
