...
export const ja: TranslationStructure = {
  ...
  workflows: {
    ...
    sectionEffort: "推論の強度",
    effortDefault: "デフォルト",
    modelFollowsSettings: "設定のデフォルトに従います",
    loopEditModalTitle: "ループを編集",
    detailEdit: "編集",
    ...
    actionRunNow: "今すぐ実行",
    actionRunNowSuccessTitle: "ループを実行しました",
    actionRunNowSuccessMessage: "新しいイテレーションを開始しました。下のセッションをまもなく確認できます。",
    actionRunNowErrorTitle: "ループを実行できませんでした",
    ...
    loopBootstrapSlashCommandPresetsLabel: "よく使うスキル",
    loopBootstrapSlashCommandPresetNone: "なし",
    ...
    loopIssueHintToggleShow: "💡 結果を Git に書き戻すには",
    loopIssueHintToggleHide: "ヒントを隠す",
    webhookIssueHint: "Have the Agent run `happy issue comment <n> --body \"…\"` or `issue close <n>` before exiting — token is already in env.",
    webhookIssueHintToggleShow: "💡 Issue にコメントを返すには",
    webhookIssueHintToggleHide: "ヒントを隠す",
  },
  ...
  settings: {
    ...
    appLock: "アプリロック",
    appLockSubtitle: "アプリを開くときに PIN または生体認証を要求します",
    featuresTitle: "機能",
  ...
  settingsFeatures: {
    ...
    scoringModel: "スコアリングモデル",
    scoringModelDescription: "プロバイダーごとのオプション関連性スコアリングに使用するLLMモデルを上書きします。デフォルト（Anthropic → Haiku、OpenAI → GPT-4o-mini）を使用するには空のままにしてください。",
    scoringModelProvider: "{{provider}} モデル",
    scoringModelPlaceholder: "デフォルト",
  ...
  session: {
    ...
    queuePausedWithCount: ({ n }: { n: number }) => `一時停止中 · ${n}件のメッセージが待機中`,
    sendNow: "今すぐ送信",
    pauseQueue: "キューを一時停止",
    resumeQueue: "再開",
    queuedMessagePreview: "メッセージプレビュー",
    editQueuedMessage: "メッセージを編集",
    editMode: "編集",
    saveChanges: "保存",
    saveAndSendNow: "保存して送信",
    cancelEdit: "キャンセル",
    queueItemNotFound: "このメッセージは既に送信または削除されており、保存できません。",
    saveAndSendFailed: "編集したメッセージを送信できませんでした。キューに保持しているので再試行できます。",
    imagesCount: ({ n }: { n: number }) => `画像 ${n}枚`,
    charsCount: ({ n }: { n: number }) => `${n}文字`,
    ...
    codeExpandLines: ({ n }: { n: number }) => `展開（${n} 行）`,
  ...
  sessionInfo: {
    ...
    worktreeActivity: "Worktree のアクティビティ",
    worktreeCreated: "Worktree を作成",
    worktreeRemoved: "Worktree を削除",
    recentFileChanges: "最近のファイル変更",
    fileEventAdd: "追加",
    fileEventChange: "変更",
    fileEventUnlink: "削除",
    ...
    exportTranscript: "トランスクリプトをエクスポート",
    exportTranscriptSubtitle: "セッションメッセージをJSONLとしてクリップボードにコピー",
    exportTranscriptSuccess: "トランスクリプトをクリップボードにコピーしました",
    exportTranscriptFailed: "トランスクリプトのエクスポートに失敗しました",
    exportTranscriptEmpty: "エクスポートするメッセージがありません",
  },
  ...
  settingsAppLock: {
    title: "アプリロック",
    enable: "アプリロック",
    enableSubtitle: "この端末でアプリを開くときに PIN を要求します",
    changePin: "PIN を変更",
    biometric: "生体認証で解除",
    biometricSubtitle: "Face ID、Touch ID、または指紋で解除します",
    timeout: "PIN の要求",
    timeoutSubtitle: "アプリがバックグラウンドに移ってから再びロックするまでの時間を選びます。",
    timeoutImmediate: "すぐに",
    timeout30s: "30 秒後",
    timeout1m: "1 分後",
    timeout5m: "5 分後",
    timeoutNever: "しない",
    lockNow: "今すぐロック",
    footer: "アプリロックはこの端末でのアプリへのアクセスのみを制御します。アカウントのエンドツーエンド暗号化は変更されません。",
    setupTitle: "PIN を設定",
    setupEnterNew: "新しい PIN を入力",
    setupConfirm: "PIN を確認",
    setupHint: "6 桁の PIN を設定してください",
    setupMismatch: "PIN が一致しません。もう一度お試しください。",
    unlockTitle: "PIN を入力",
    unlockPrompt: "解除するには PIN を入力してください",
    incorrect: "PIN が正しくありません",
    lockedOut: ({ seconds }: { seconds: number }) => `試行回数が多すぎます。${seconds} 秒後にもう一度お試しください`,
    biometricPrompt: "Happy のロックを解除",
    biometricButton: "生体認証を使う",
    forgotPin: "PIN をお忘れですか？",
    forgotTitle: "アプリロックをリセットしますか？",
    forgotMessage: "PIN をリセットするにはログアウトします。再度ログインして新しい PIN を設定してください。データは安全に保たれます。",
    forgotConfirm: "ログアウト",
    disableTitle: "アプリロックをオフにしますか？",
    disableMessage: "この端末でアプリを開くのに PIN や生体認証が不要になります。",
  ...
  machine: {
    ...
    agentLoopMaxUsdPerRun: "1回あたりの最大予算 (USD)",
    agentLoopMaxUsdPerRunPlaceholder: "例: 1.00",
    agentLoopMaxUsdPerRunInvalid: "1回あたりの予算は正の数でなければなりません",
    agentLoopMaxUsdPerDay: "1日あたりの最大予算 (USD)",
    agentLoopMaxUsdPerDayPlaceholder: "例: 5.00",
    agentLoopMaxUsdPerDayInvalid: "1日あたりの予算は正の数でなければなりません",
    agentLoopTotalCostUsd: "合計コスト",
    agentLoopTodayCostUsd: "今日のコスト",
    agentLoopLastRunCostUsd: "前回実行のコスト",
  ...
  tasks: {
    ...
    worktreeIsolation: "Worktreeの隔離",
    worktreeIsolationDesc: "このタスク用に専用のGit worktreeを作成し、現在の作業ディレクトリをそのままにします。",
    statusQueued: "待機中",
  ...
  projects: {
    ...
    tabConfig: "設定",
    tabTraces: "トレース",
    tracesEmpty: "ツール呼び出しはまだありません",
    tracesEmptySubtitle: "アクティブセッション中にツール呼び出しがここに表示されます",
    tracesNoSession: "アクティブセッションなし",
    ...
    knowledgeFilterSummary: "セッション要約",
    knowledgeFilterRepoMap: "リポジトリマップ",
    ...
    knowledgeConfigModeAutoHint: "キーワード関連性でランキングし最大5件を注入。コンテキストとトークンコストの最適バランス",
    knowledgeConfigModeFullHint: "セッションごとに最大20件を注入。コンテキストは豊富だがトークン消費が増加",
    knowledgeConfigModeMinimalHint: "プロジェクトプロファイル（技術スタック、規約）のみ注入。個別ナレッジは注入しない",
    knowledgeConfigSensitivity: "収集感度",
    knowledgeConfigSensitivityConservativeHint: "5回の価値あるターンまたは60分ごとに抽出。少ないが高品質",
    knowledgeConfigSensitivityBalancedHint: "3回の価値あるターンまたは30分ごとに抽出。カバレッジとノイズのバランス",
    knowledgeConfigSensitivityAggressiveHint: "価値あるターンごとに即座に抽出（最大10分）。最多だがノイズも多い",
    knowledgeConfigCollection: "収集トリガー",
    knowledgeConfigTrackFileEdits: "ファイル編集を追跡",
    knowledgeConfigTrackFileEditsHint: "AIがファイルを作成・変更した場合 → そのターンを価値ありとマーク。3ターン蓄積ごとにサーバーへ送信（ファイルごとではない）",
    knowledgeConfigTrackTokens: "深い分析を追跡",
    knowledgeConfigTrackTokensHint: "ファイル変更なしでも出力が1500トークンを超えるターン（深い推論、設計検討）→ 価値ありとマーク",
    knowledgeConfigSummary: "セッション概要",
    knowledgeConfigSummaryHint: "セッション終了時に価値あるターンが2回以上 → セッション全体の概要を自動生成。AIで精製",
    ...
    knowledgeConfigMergeHint: "類似度≥75%のエントリを検索、クラスタごとに2-5件統合（最大5クラスタ/回）。元エントリは「置換済み」に。6時間ごとに実行",
    ...
    ciStatus: "CI ステータス",
    ciStatusEmpty: "CI の実行記録がありません。GitHub Webhook を設定するとビルド状況がここに表示されます。",
  },
  project: {
    segments: {
      board: "ボード",
  ...
  diagnostics: {
    ...
    smartClean: "スマートクリーン",
    smartCleanEmpty: "古いセッションは検出されませんでした",
    smartCleanConfirmTitle: "古いセッションをクリーン",
    smartCleanConfirmMessage: ({ count }: { count: number }) =>
      `${count}件の古いセッションを終了しますか？`,
    smartCleanSuccess: ({ killed }: { killed: number }) =>
      `${killed}件の古いセッションをクリーンしました`,
    smartCleanFailed: "古いセッションのクリーンに失敗しました",
  ...
  supervisor: {
    ...
    dimPrReview: "PRコードレビュー",
    dimPrReviewNote: "PR変更のセキュリティ、品質、テストカバレッジ",
    dimResearch: "リサーチ",
    ...
    autoLoopSection: "健康度回帰で自動 Loop",
    autoLoopEnabled: "自動 Loop を有効化",
    autoLoopDesc: "分析が閾値以上の health score を報告したら自動的に Supervisor Loop を開始",
    autoLoopThreshold: "健康度しきい値",
    autoLoopThresholdHint: ({ value }: { value: number }) => `healthScore ≥ ${value} で自動 Loop が発火。値が大きいほど不健康。`,
    autoLoopDebounce: "クールダウン（時間）",
    autoLoopDebounceHint: ({ hours }: { hours: number }) => `このプロジェクトの自動 Loop 起動間隔は ${hours} 時間`,
    autoLoopDebounceHintOff: "クールダウンなし — 適格なラン完了ごとに自動 Loop が発火（テストモード）",
    autoLoopResetButton: "クールダウンを今すぐリセット",
    autoLoopResetTitle: "自動 Loop のクールダウンをリセット？",
    ...
    loopConfigMaxFailures: "連続失敗の最大回数",
    loopConfigMaxFailuresHint: ({ count }: { count: number }) => `${count} 回連続失敗でループを中止`,
    loopConfigHealthTarget: "健康度目標",
    loopConfigHealthTargetHint: ({ value }: { value: number }) => `healthScore が ${value} 以下に下がったら終了`,
    loopConfigHealthTargetHintOff: "健康度目標なし — no_new_actions / goal_achieved / max_iterations / コスト上限のいずれかで終了",
    loopConfigDuration: "時間制限",
    loopConfigDurationHint: ({ hours }: { hours: number }) => `${hours} 時間後に timeout 理由で強制終了`,
    loopConfigEmptyIters: "収束確認回数",
    loopConfigEmptyItersHint: ({ count }: { count: number }) => `${count} 回連続で新規発見なし → 「目標達成」で終了`,
    loopConfigEmptyItersHintLegacy: "初回の空分析で終了（旧版の単発動作）",
  ...
  projectConfig: {
    ...
    sectionResearch: "競合リサーチ",
    sectionKnowledge: "ナレッジベース",
    sectionNotifications: "通知とプロフィール",
    sectionIntegrations: "インテグレーションとWebhook",
    supervisorMode: "モード",
    modeSuggest: "提案",
    modeSemiAuto: "半自動",
    modeAuto: "自動",
    ...
    supervisorPush: "プッシュトリガー",
    researchDimensions: "ディメンション",
    researchDirection: "方向性",
    researchRules: "ルール",
    rulesLines: "行",
    researchHint: "リサーチのデフォルト設定はここで構成します。実行ごとの上書きはリサーチタブにあります。",
    knowledgeNotAvailable: "ナレッジ設定が利用できません。最初にプロジェクトをサーバーと同期してください。",
    notificationsEnabled: "通知",
    defaultProfile: "AIプロフィール",
    profileDefault: "デフォルト",
    webhookEvents: "WEBHOOKイベント",
    webhookNoEvents: "Webhookイベントはまだありません",
    viewAll: "すべて表示",
    machineTriggers: "マシントリガー",
    movedToConfigHint: "設定は設定タブに移動しました",
    sectionContextMd: "プロジェクトコンテキスト",
    contextMdDesc: "すべての新しいエージェントセッションに自動的に注入されます",
    contextMdEdit: "CONTEXT.mdを編集",
    contextMdNoSession: "アクティブなセッションがありません — 編集するにはセッションを開始してください",
    contextMdTitle: "プロジェクトコンテキストを編集",
    contextMdSave: "保存",
    contextMdSaved: "保存しました",
    contextMdSaveError: "保存に失敗しました",
    contextMdPlaceholder: "プロジェクトを説明してください：技術スタック、規約、主要なアーキテクチャの決定...",
  ...
  claudeControl: {
    ...
    fileViewer: {
      ...
      close: "閉じる",
      loading: "読み込み中…",
      truncated: "1 MiBに切り詰め",
      deniedBlacklistedPath: "CLIセキュリティポリシーによりパスがブロックされています",
      deniedPermissionDenied: "Claude Codeによりアクセスが拒否されました",
      deniedTooLarge: "ファイルが大きすぎます",
      deniedNotFound: "ファイルが見つかりません",
      deniedError: "ファイルを読み込めませんでした",
    },
    mcp: {
      title: "MCPツールを呼び出す",
      stepSelect: "1. ツールを選択",
      stepConfirm: "2. 確認",
      reviewHeading: "呼び出す前に確認",
      confirmCheckbox: "MCPツールを直接実行することを理解しています",
      invoke: "呼び出す",
      result: "結果",
      errorNotWhitelisted: "リモートCLIのホワイトリストにMCPサーバーがありません",
      errorServerUnavailable: "MCPサーバーが利用できません",
      errorToolNotFound: "サーバーにツールが見つかりません",
      errorInvalidArguments: "無効な引数",
      errorPermissionDenied: "権限が拒否されました",
      errorSdkNotImplemented: "Claude Agent SDKを待機中 — mcp_callランタイムはまだ利用できません",
      errorUnknown: "不明なエラー",
    },
    contextUsage: {
      title: "コンテキスト使用量",
      ...
      noMemoryFiles: "未読み込み",
      noMcpTools: "未読み込み",
      detailLoading: "コンテンツを読み込み中…",
      detailError: "コンテンツの読み込みに失敗しました",
      detailItems: "{n}件",
  ...
  world: {
    title: "ワールド",
    subtitle: "グローバルエージェントワークスペースに入る",
    exitWorld: "ワールドを出る",
    streamMode: "イベントストリーム",
    noEvents: "まだイベントがありません",
    emptyTitle: "マトリックスは静かです",
    emptyDescription: "プログラムが実行されるとここに表示されます。セッションを開始するかタスクをトリガーしてワールドを動かしてください。",
    filterAll: "すべて",
    ...
    chainMode: "チェーン",
    agentMode: "エージェント",
    noAgents: "アクティブなエージェントがありません",
    agentModeEmptyDescription: "接続されたマシンでセッションがアクティブになるとエージェントがここに表示されます。",
    agentIdle: "アイドル",
    noChainResults: "検索に一致するチェーンがありません",
    policyDescDisabled: "手動のみ — 自動アクションなし",
    policyDescSuggest: "次のステップを提案し、確認を待ちます",
    policyDescSemiAuto: "ルーティンアクションを自動で処理し、例外をエスカレートします",
    policyDescAuto: "完全自律 — すべての決定を待たずに実行します",
    inspector: "イベント詳細",
    openSession: "セッションを開く",
    ...
    densityEvents: "イベント",
    densityActive: "アクティブ",
    densityViewStream: "ストリームで表示",
    densityEmpty: "まだアクティビティがありません",
    densityEmptyDesc: "イベントが発生するとプロジェクトがここに表示されます。",
    densityTotal: "合計",
    densityRecent: "30分",
    densityLastActivity: "最終アクティビティ",
    emptyFilterTitle: "一致するイベントがありません",
    emptyFilterDesc: "現在のフィルターに一致するイベントがありません。クリアしてみてください。",
    emptyClearFilter: "フィルターをクリア",
    emptyActionNewSession: "新しいセッション",
    emptyActionQueueTask: "タスクをキューに追加",
    emptyQuickStart: "/ でコマンドを入力",
  },
} as const;
