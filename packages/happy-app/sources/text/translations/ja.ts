...
export const ja: TranslationStructure = {
  ...
  settingsVoice: {
    ...
    livekitConfigDescription: "任意：ご自身の LiveKit Cloud API Key と Secret を入力してください。使用量はサーバーではなくお客様の LiveKit アカウントに課金されます。",
    ...
    ttsProviderTitle: "TTSプロバイダー",
    ttsProviderDescription: "テキストを音声に変換する方法を選択してください。無料オプションはセットアップ不要です。",
    ttsProviderWebSpeech: "Web Speech API",
    ttsProviderWebSpeechDescription: "ゼロコストのブラウザネイティブTTS — アカウント不要",
    ttsProviderWebSpeechNote: "デバイスの内蔵テキスト読み上げエンジンを使用します。セットアップなしですぐに使えます。",
    ttsProviderEdge: "Microsoft Edge TTS",
    ttsProviderEdgeDescription: "Microsoftの無料高品質クラウドTTS",
    ttsProviderEdgeNote: "MicrosoftのTTSサービスに接続します。無料、APIキー不要。",
    ttsProviderVoicebox: "Voicebox（ローカル）",
    ttsProviderVoiceboxDescription: "高品質ローカルTTS — デバイスでVoiceboxの実行が必要",
    ttsProviderElevenLabs: "ElevenLabs",
    ttsProviderElevenLabsDescription: "プレミアムAI音声 — 独自のAPIキーが必要",
