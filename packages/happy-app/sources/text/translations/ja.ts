...
export const ja: TranslationStructure = {
  ...
  settingsFeatures: {
    ...
    knowledgeBaseSensitivityConservative: "控えめ — より少なく高品質なエントリ",
    knowledgeBaseSensitivityBalanced: "バランス — デフォルトの収集しきい値",
    knowledgeBaseSensitivityAggressive: "積極的 — より多くのナレッジを取得",
