...
/**
 * Simplified composer for starting new OpenClaw sessions.
 * Styled to match the main app's AgentInput component.
 */
export default React.memo(function OpenClawNewSessionScreen() {
  const router = useRouter();
  const { theme } = useUnistyles();
  const insets = useSafeAreaInsets();
  const { isConnected, mainSessionKey } = useOpenClawStatus();
  ...
  const handleSend = React.useCallback(async () => {
    ...
    try {
      ...
      await OpenClawSocket.sendMessage(sessionKey, message);
      ...
      <View style={styles.content}>
        <View style={styles.promptContainer}>
          ...
          <Text style={[styles.title, { color: theme.colors.text }]}>
            {t("openclaw.newSessionTitle")}
          </Text>
          <Text
            style={[styles.subtitle, { color: theme.colors.textSecondary }]}
          >
            {t("openclaw.newSessionDescription")}
          </Text>
        </View>
      </View>
          ...
          >
            ...
            <View style={styles.inputContainer}>
              <MultiTextInput
                ...
                placeholder={t("openclaw.newSessionPlaceholder")}
