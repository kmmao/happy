    ...
    Modal.alert(
      ...
      [
        { text: t("common.cancel"), style: "cancel" },
        {
          ...
          style: "destructive",
          onPress: async () => {
            await roadmapStore.getState().deleteMilestone(milestone.id);
            router.back();
          },
        },
      ],
  ...
  if (!milestone) {
    return (
      ...
      >
        <Header
          title={
            isStoreLoaded ? t("roadmap.milestoneNotFound") : t("common.loading")
          }
        />
      ...
      >
          ...
          <ItemGroup>
            {milestoneFeatures.map((f, idx) => (
              <Item
                key={f.id}
                title={f.title}
                onPress={() => router.push(`/roadmap/feature/${f.id}`)}
        ...
        <ItemGroup>
          <Item
            ...
            onPress={() =>
              router.push(`/roadmap/feature/new?milestoneId=${milestone.id}`)
            }
            showDivider
          />
          <Item
