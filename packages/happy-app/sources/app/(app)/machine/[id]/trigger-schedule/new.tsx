...
function NewTriggerSchedulePage() {
    ...
    const effective = useRuntimeProfileEffective(selectedProjectId, "cron");
    ...
    const [loading, doCreate] = useHappyAction(
        React.useCallback(async () => {
            ...
            router.back();
        }, [machineId, name, cronExpression, prompt, priority, selectedProjectId, selectedSkillIds, selectedProfileId, canSubmit, router]),
    );
