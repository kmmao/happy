...
export default function RootLayout() {
  ...
  return (
    ...
    >
      ...
      />
      <Stack.Screen
        name="session/[id]/pr-diff"
        options={{
          headerShown: true,
          headerTitle: t("githubPr.title"),
          headerBackTitle: t("common.back"),
        }}
      />
      <Stack.Screen
      ...
      />
      <Stack.Screen
        name="session/[id]/workflow-new"
        options={{
          headerShown: true,
          headerTitle: t("dynamicWorkflows.newTitle"),
          headerBackTitle: t("common.back"),
        }}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        ...
        options={{
          headerTitle: t("settingsAgents.title"),
        }}
      />
      <Stack.Screen
      ...
      <Stack.Screen
        name="settings/mcp"
        options={{
          headerTitle: t("settingsMcp.title"),
          headerBackTitle: t("common.back"),
        }}
      />
      <Stack.Screen
