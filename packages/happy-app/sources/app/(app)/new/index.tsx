...
function NewSessionWizard() {
  ...
  const [permissionMode, setPermissionMode] = React.useState<PermissionMode>(
    () => {
      ...
      const validCodexGeminiModes: PermissionMode[] = [
        "default",
        "read-only",
        "safe-yolo",
        "yolo",
      ...
      if (lastUsedPermissionMode) {
        if (
          ...
          validCodexGeminiModes.includes(
            lastUsedPermissionMode as PermissionMode,
          )
        ) {
  ...
  const [modelMode, setModelMode] = React.useState<ModelMode>(() => {
    const validClaudeModes: ModelMode[] = [
      "default",
      "adaptiveUsage",
      "sonnet",
      "opus",
    ...
    if (lastUsedModelMode) {
      if (
        agentType === "codex" &&
        validCodexModes.includes(lastUsedModelMode as ModelMode)
      ) {
  ...
  React.useEffect(() => {
    ...
    if (!isValidForCurrentAgent) {
      ...
      if (agentType === "codex") {
        ...
        setModelMode("gemini-3-pro-preview");
      } else {
  ...
  const handleCreateSession = React.useCallback(async () => {
    ...
    try {
      ...
      if ("sessionId" in result && result.sessionId) {
        ...
        storage
          .getState()
          .updateSessionPermissionMode(result.sessionId, permissionMode);
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <Pressable
                            onPress={() =>
                              handleCLIBannerDismiss("claude", "machine")
                            }
                            style={{
                              borderRadius: 4,
                              borderWidth: 1,
                          ...
                          <Pressable
                            onPress={() =>
                              handleCLIBannerDismiss("claude", "global")
                            }
                            style={{
                              borderRadius: 4,
                              borderWidth: 1,
                        ...
                        <Pressable
                          onPress={() =>
                            handleCLIBannerDismiss("claude", "temporary")
                          }
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <Pressable
                            onPress={() =>
                              handleCLIBannerDismiss("codex", "machine")
                            }
                            style={{
                              borderRadius: 4,
                              borderWidth: 1,
                          ...
                          <Pressable
                            onPress={() =>
                              handleCLIBannerDismiss("codex", "global")
                            }
                            style={{
                              borderRadius: 4,
                              borderWidth: 1,
                        ...
                        <Pressable
                          onPress={() =>
                            handleCLIBannerDismiss("codex", "temporary")
                          }
                          hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}
                        >
                          <Ionicons
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <Pressable
                            onPress={() =>
                              handleCLIBannerDismiss("gemini", "machine")
                            }
                            style={{
                              borderRadius: 4,
                              borderWidth: 1,
                          ...
                          <Pressable
                            onPress={() =>
                              handleCLIBannerDismiss("gemini", "global")
                            }
                            style={{
                              borderRadius: 4,
                              borderWidth: 1,
                        ...
                        <Pressable
                          onPress={() =>
                            handleCLIBannerDismiss("gemini", "temporary")
                          }
                          hitSlop={{ top: 8, bottom: 8, left: 8, right: 8 }}
                        >
                          <Ionicons
