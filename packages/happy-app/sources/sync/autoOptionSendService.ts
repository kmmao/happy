...
class AutoOptionSendService {
    ...
    private fireTimerFinished(sessionId: string): void {
        ...
        // Ranking is settled when the candidate is armed; there is no late
        // re-rank here any more. This block used to apply an LLM score that
        // arrived mid-countdown, which only mattered while semantic scoring
        // existed.
