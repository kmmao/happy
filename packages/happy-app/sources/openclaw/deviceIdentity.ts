 ...
 * Uses Ed25519 for signing, matching the official implementation.
 */
...
const DEVICE_AUTH_TOKEN_KEY = "openclaw_device_auth_token";
 ...
 * Uses expo-crypto for React Native compatibility (crypto.subtle is unavailable)
 */
