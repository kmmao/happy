...
const FILTER_KEYS = ["all", "discovery", "decision", "fix", "convention", "warning", "summary", "repo_map", "has-evolution", "superseded", "archived"] as const;
...
function filterLabel(key: FilterKey): string {
    switch (key) {
        ...
        case "summary":
            return t("projects.knowledgeFilterSummary");
        case "repo_map":
