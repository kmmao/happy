...
export const GitHostAutoIssueForm = React.memo(function GitHostAutoIssueForm({
  theme,
  formAutoEnabled,
  formAutoLabel,
  formAutoAuthors,
  ...
  return (
    <View>
      ...
      >
        ...
        <Switch value={formAutoEnabled} onValueChange={onAutoEnabledChange} />
      </View>
      <Text
        style={{
          fontSize: 12,
      ...
      {formAutoEnabled && (
        <>
          <FieldLabel theme={theme}>{t("gitHosts.autoIssueLabel")}</FieldLabel>
          <TextInput
            style={{
          ...
          <TextInput
            ...
            placeholder={t("gitHosts.autoIssueAllowedAuthorsPlaceholder")}
            placeholderTextColor={theme.colors.textSecondary}
            autoCapitalize="none"
            autoCorrect={false}
          />
