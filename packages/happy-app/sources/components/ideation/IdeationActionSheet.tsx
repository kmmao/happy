        ...
        >
          ...
          {otherStatuses.map((status) => (
            <Pressable
              ...
              accessibilityLabel={t(IDEATION_STATUS_LABELS[status])}
              style={({ pressed }) => [
                styles.actionItem,
                pressed && { opacity: 0.6 },
              ]}
            >
              <Ionicons
                name={STATUS_ICONS[status] as keyof typeof Ionicons.glyphMap}
                size={18}
          ...
          {idea.status !== "converted" && (
            <Pressable
              ...
              accessibilityRole="button"
              accessibilityLabel={t("ideation.convertToTask")}
              style={({ pressed }) => [
                styles.actionItem,
                pressed && { opacity: 0.6 },
              ]}
          ...
          {idea.convertedTaskId && (
            <Pressable
              ...
              accessibilityRole="button"
              accessibilityLabel={t("ideation.viewTask")}
              style={({ pressed }) => [
                styles.actionItem,
                pressed && { opacity: 0.6 },
              ]}
