            ...
            switch (realtimeStatus) {
                ...
                case "error":
                    return {
                        ...
                        isPulsing: false,
                        text: t("voiceStatusBar.connectionError"),
                    };
                case "connected": {
                    ...
                    switch (realtimeMode) {
                        case "listening":
                            return {
                                ...
                                isPulsing: true,
                                text: t("voiceStatusBar.listening"),
                            };
                        case "thinking":
                            return {
                                ...base,
                                ...
                                isPulsing: true,
                                text: t("voiceStatusBar.processing"),
                            };
                        case "speaking":
                            return {
                                ...base,
                                color: connectedColor,
                                isPulsing: false,
                                text: t("voiceStatusBar.speaking"),
                            };
                        default:
                            return {
                                ...base,
                                color: connectedColor,
                                isPulsing: false,
                                text: t("voiceStatusBar.voiceAssistantActive"),
                            };
                    }
                }
                default:
                    return {
                        ...
                        isPulsing: false,
                        text: t("voiceStatusBar.voiceAssistant"),
                    };
            }
